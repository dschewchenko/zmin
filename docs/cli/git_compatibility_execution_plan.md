...
The current frozen focused-oracle backlog is `961` functions: `691`
represented or classified and `270` `missing_or_unclassified`. Treat
...
`git_transport_http_compat.rs`, `git_pack_integrity_compat.rs` and
