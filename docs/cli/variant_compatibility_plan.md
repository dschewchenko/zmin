...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 23/151 commands with matrix rows / 226/4632 represented doc-option pairs / 825 written rows / 727 written rows matching stock Git / 0 open written rows`
...
The latest closed guard classification is `git reflog --date=bogus`.
...
`0/825`; the complete command matrices and complete doc-option matrices remain
`0/151` and `0/4632`.
...
Tracked closed blocks in this table: `489` verified variants.
