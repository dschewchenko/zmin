...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 15/151 commands with matrix rows / 223/4632 represented doc-option pairs / 722 written rows / 646 written rows matching stock Git / 0 open written rows`
...
Tracked closed blocks in this table: `413` verified variants.
