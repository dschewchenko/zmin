...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 8/151 commands with matrix rows / 178/4632 represented doc-option pairs / 522 written rows / 475 written rows matching stock Git / 9 open written rows`
