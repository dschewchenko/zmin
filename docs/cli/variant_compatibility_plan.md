...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 11/151 commands with matrix rows / 207/4632 represented doc-option pairs / 590 written rows / 517 written rows matching stock Git / 9 open written rows`
