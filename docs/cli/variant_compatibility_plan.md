...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 50/151 commands with matrix rows / 272/4632 represented doc-option pairs / 1122 written rows / 851 written rows matching stock Git / 0 partial written rows / 1 open written rows`
...
This card is the exact handoff target after the current `1122` written-row
...
`0/1122`; the `1/1122` open row and the still incomplete command/doc-option
