...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 2/151 commands with matrix rows / 50/4632 represented doc-option pairs / 245 written rows / 230 written rows matching stock Git / 9 open written rows`
...
Tracked closed blocks in this table: `327` verified variants.
