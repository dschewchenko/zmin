...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 15/151 commands with matrix rows / 218/4632 represented doc-option pairs / 665 written rows / 592 written rows matching stock Git / 2 open written rows`
