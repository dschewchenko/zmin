...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 9/151 commands with matrix rows / 191/4632 represented doc-option pairs / 553 written rows / 493 written rows matching stock Git / 9 open written rows`
