...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 102/151 commands with matrix rows / 605/4632 represented doc-option pairs / 2630 written rows / 2253/2630 written rows matching stock Git / 0 partial written rows / 1 open written rows`
...
complete current backlog list to walk: `961` focused oracle functions, `683`
represented or classified and `278` `missing_or_unclassified`. If the generated
...
backlog snapshot at `961` focused oracle functions: `683` already represented
or classified and `278` still `missing_or_unclassified`. Treat that snapshot as
...
The oracle inventory now lists `683` represented/classified functions and
`278` `missing_or_unclassified`. Current written rows are `2630`, with
`2253/2630` matching stock Git, `1/2630` open and `376/2630` invalid-input. No
