...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 5/151 commands with matrix rows / 114/4632 represented doc-option pairs / 379 written rows / 344 written rows matching stock Git / 9 open written rows`
