...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 24/151 commands with matrix rows / 229/4632 represented doc-option pairs / 830 written rows / 730 written rows matching stock Git / 0 open written rows`
...
The latest closed guard classification is `git blame --color-lines a.txt`.
...
`0/830`; the complete command matrices and complete doc-option matrices remain
`0/151` and `0/4632`.
...
Tracked closed blocks in this table: `494` verified variants.
