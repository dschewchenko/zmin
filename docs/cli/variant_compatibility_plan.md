...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 108/151 commands with matrix rows / 725/4632 represented doc-option pairs / 2840 written rows / 2451/2840 written rows matching stock Git / 0 partial written rows / 1 open written rows`
...
Current written rows are `2840`, with `2451/2840` matching stock Git, `1/2840`
open and `388/2840` invalid-input.
