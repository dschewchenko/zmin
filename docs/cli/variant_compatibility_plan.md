...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 25/151 commands with matrix rows / 233/4632 represented doc-option pairs / 846 written rows / 732 written rows matching stock Git / 0 open written rows`
...
`git ls-files --recurse-submodules --with-tree=HEAD`.
...
`0/846`; the complete command matrices and complete doc-option matrices remain
`0/151` and `0/4632`.
