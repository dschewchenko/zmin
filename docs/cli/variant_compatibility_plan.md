...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 14/151 commands with matrix rows / 214/4632 represented doc-option pairs / 619 written rows / 543 written rows matching stock Git / 8 open written rows`
...
Tracked closed blocks in this table: `336` verified variants.
