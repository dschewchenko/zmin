...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 26/151 commands with matrix rows / 236/4632 represented doc-option pairs / 891 written rows / 742 written rows matching stock Git / 0 open written rows`
...
`git blame -L //,+1 a.txt`, and `git blame -L ^// a.txt` empty start-regex
failures.
...
`0/891`; the complete command matrices and complete doc-option matrices remain
`0/151` and `0/4632`.
