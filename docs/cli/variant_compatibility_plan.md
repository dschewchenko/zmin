...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 38/151 commands with matrix rows / 241/4632 represented doc-option pairs / 1020 written rows / 778 written rows matching stock Git / 1 partial written row / 0 open written rows`
...
This card is the exact handoff target after the current `1020` written-row
...
`0/1020`; the complete command matrices and complete doc-option matrices remain
`0/151` and `0/4632`.
...
Tracked closed blocks in this table: `652` verified variants.
