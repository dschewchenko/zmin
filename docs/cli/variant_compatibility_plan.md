...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 15/151 commands with matrix rows / 220/4632 represented doc-option pairs / 705 written rows / 625 written rows matching stock Git / 7 open written rows`
