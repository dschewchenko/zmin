...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 22/151 commands with matrix rows / 226/4632 represented doc-option pairs / 824 written rows / 727 written rows matching stock Git / 0 open written rows`
...
The latest closed guard classification is `git log --decorate=bogus -1`.
...
`0/824`; the complete command matrices and complete doc-option matrices remain
`0/151` and `0/4632`.
...
Tracked closed blocks in this table: `488` verified variants.
