...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 102/151 commands with matrix rows / 644/4632 represented doc-option pairs / 2703 written rows / 2315/2703 written rows matching stock Git / 0 partial written rows / 1 open written rows`
...
`258` `missing_or_unclassified`. Current written rows are `2703`, with
`2315/2703` matching stock Git, `1/2703` open and `387/2703` invalid-input. No
