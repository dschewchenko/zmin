...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 17/151 commands with matrix rows / 225/4632 represented doc-option pairs / 805 written rows / 726 written rows matching stock Git / 0 open written rows`
...
`0/805`; the complete command matrices and complete doc-option matrices remain
`0/151` and `0/4632`.
