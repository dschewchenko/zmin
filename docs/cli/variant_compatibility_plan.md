...
`0/151 complete command matrices / 0/4632 complete doc-option matrices / 10/151 commands with matrix rows / 196/4632 represented doc-option pairs / 563 written rows / 500 written rows matching stock Git / 9 open written rows`
