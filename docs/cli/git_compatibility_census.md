...
| Existing matrix rows | `2715` | evidence layer, not full denominator |
| Verified exact rows | `2327` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `781` | schema args and additional schema paths without exact matrix evidence |
