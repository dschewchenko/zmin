...
| Existing matrix rows | `2790` | evidence layer, not full denominator |
| Verified exact rows | `2402` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `729` | schema args and additional schema paths without exact matrix evidence |
