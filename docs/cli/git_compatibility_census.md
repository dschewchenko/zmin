...
| Existing matrix rows | `2721` | evidence layer, not full denominator |
| Verified exact rows | `2333` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `777` | schema args and additional schema paths without exact matrix evidence |
