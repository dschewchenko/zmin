...
| Existing matrix rows | `2840` | evidence layer, not full denominator |
| Verified exact rows | `2451` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `682` | schema args without exact matrix evidence |
