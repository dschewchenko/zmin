...
| Existing matrix rows | `2734` | evidence layer, not full denominator |
| Verified exact rows | `2346` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `762` | schema args and additional schema paths without exact matrix evidence |
| Remaining checklist rows | `4680` | doc-option expansion, exact opens and unclassified guards |
