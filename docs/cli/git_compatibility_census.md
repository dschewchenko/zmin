...
| Existing matrix rows | `2757` | evidence layer, not full denominator |
| Verified exact rows | `2369` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `738` | schema args and additional schema paths without exact matrix evidence |
