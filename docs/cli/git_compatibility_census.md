...
| Existing matrix rows | `2740` | evidence layer, not full denominator |
| Verified exact rows | `2352` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `756` | schema args and additional schema paths without exact matrix evidence |
