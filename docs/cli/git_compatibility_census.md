...
| Existing matrix rows | `2723` | evidence layer, not full denominator |
| Verified exact rows | `2335` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `776` | schema args and additional schema paths without exact matrix evidence |
| Remaining checklist rows | `4681` | doc-option expansion, exact opens and unclassified guards |
