...
| Existing matrix rows | `2843` | evidence layer, not full denominator |
| Verified exact rows | `2454` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `679` | schema args without exact matrix evidence |
