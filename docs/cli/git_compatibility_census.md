...
| Existing matrix rows | `2842` | evidence layer, not full denominator |
| Verified exact rows | `2453` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `680` | schema args without exact matrix evidence |
