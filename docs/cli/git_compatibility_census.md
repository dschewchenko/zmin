...
| Existing matrix rows | `2738` | evidence layer, not full denominator |
| Verified exact rows | `2350` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `758` | schema args and additional schema paths without exact matrix evidence |
