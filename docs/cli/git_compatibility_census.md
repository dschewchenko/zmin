...
| Existing matrix rows | `2736` | evidence layer, not full denominator |
| Verified exact rows | `2348` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `760` | schema args and additional schema paths without exact matrix evidence |
