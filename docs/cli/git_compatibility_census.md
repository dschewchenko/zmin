...
| Existing matrix rows | `2845` | evidence layer, not full denominator |
| Verified exact rows | `2456` | closed behavior variants safe to skip exactly |
...
| Implemented but unverified rows | `677` | schema args without exact matrix evidence |
