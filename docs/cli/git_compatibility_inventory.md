...
| Git doc option pairs represented by rows | `252/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1081` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `816/1081` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1081` | no | written rows with incomplete parity |
| Open written rows | `1/1081` | no | written rows that still do not match stock Git |
| Invalid input rows | `264/1081` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `305` | `288` | `0` | `0` | `17` | `159` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `202` | `151` | `0` | `0` | `51` | `116` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `48` | `21` | `0` | `0` | `27` | `39` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1081`** | **`816`** | **`0`** | **`1`** | **`264`** | **`683`** |
...
Never use `151/151` command presence, `4632` option spellings, `252/4632`
represented option pairs or `816/1081` passing written rows as a Git support
percentage. The `816/1081` number is audit progress for supported rows already
written down; `0/1081` rows are partial, `1/1081` rows are open and `264/1081`
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `296` | `288` | `0` | `0` | `8` | no |
