...
| Written behavior rows | `1054` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `790/1054` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `3/1054` | no | written rows with incomplete parity |
| Open written rows | `0/1054` | no | written rows that still do not match stock Git |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `47` | `17` | `3` | `0` | `27` | `39` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1054`** | **`790`** | **`3`** | **`0`** | **`261`** | **`683`** |
...
represented option pairs or `790/1054` passing written rows as a Git support
percentage. The `790/1054` number is audit progress for supported rows already
written down; `3/1054` rows are partial and `261/1054` additional rows are
...
| `fast-import` | `25` | `0` | `1` | `docs/cli/matrices/fast_import_v2_47.tsv` | `6` | `0` | `3` | `0` | `3` | no |
