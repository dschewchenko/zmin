...
| Written behavior rows | `666` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `593/666` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `206` | `201` | `0` | `2` | `3` | `92` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`666`** | **`593`** | **`0`** | **`2`** | **`71`** | **`358`** |
...
represented option pairs or `593/666` passing written rows as a Git support
percentage. The `593/666` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `206` | `201` | `0` | `2` | `3` | no |
...
plus a smart HTTP parent fetch whose initialized submodule remote is local:
