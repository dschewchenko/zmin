...
| Written behavior rows | `123` | `108` | yes, for those rows only |
...
| Sharing and Updating Projects | `5` | `119` | `63` | `52` | `0` | `9` | `2` | `0` |
...
| **Git 2.47 unique total** | **`151`** | **`2500`** | **`123`** | **`108`** | **`0`** | **`9`** | **`6`** | **`253`** |
...
| `fetch` | `13` | `docs/cli/matrices/fetch_v2_47.tsv` | `63` | `52` | `0` | `9` | `2` |
