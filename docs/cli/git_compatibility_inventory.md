...
| Commands with any matrix rows | `34/151` | no | audit rows exist for `archive`, `bisect`, `blame`, `branch`, `bundle`, `cat-file`, `clean`, `column`, `commit-graph`, `config`, `status`, `fetch`, `diff`, `log`, `for-each-ref`, `index-pack`, `ls-files`, `ls-tree`, `merge`, `merge-base`, `multi-pack-index`, `notes`, `pack-objects`, `rebase`, `reflog`, `rerere`, `rev-parse`, `show-index`, `show-ref`, `submodule`, `symbolic-ref`, `tag`, `verify-pack` and `version` |
| Git doc option pairs represented by rows | `240/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `994` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `770/994` | yes, row by row | supported-behavior rows with parity evidence |
...
| Administration | `8` | `0` | `147` | `0` | `25` | `10` | `0` | `0` | `15` | `31` |
| Server Admin | `2` | `0` | `30` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| Plumbing Commands | `20` | `0` | `644` | `0` | `195` | `151` | `0` | `0` | `44` | `110` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `24` | `7` | `0` | `0` | `17` | `27` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`994`** | **`770`** | **`0`** | **`0`** | **`224`** | **`643`** |
...
Never use `151/151` command presence, `4632` option spellings, `240/4632`
represented option pairs or `770/994` passing written rows as a Git support
percentage. The `770/994` number is audit progress for supported rows already
written down; `224/994` additional rows are stock-compatible invalid inputs. It
...
| `bundle` | `15` | `0` | `1` | `docs/cli/matrices/bundle_v2_47.tsv` | `8` | `3` | `0` | `0` | `5` | no |
