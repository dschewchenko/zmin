...
| Written behavior rows | `857` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `739/857` | yes, row by row | supported-behavior rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `294` | `283` | `0` | `0` | `11` | `156` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`857`** | **`739`** | **`0`** | **`0`** | **`118`** | **`507`** |
...
represented option pairs or `739/857` passing written rows as a Git support
percentage. The `739/857` number is audit progress for supported rows already
written down; `118/857` additional rows are stock-compatible invalid inputs. It
...
| `submodule` | `35` | `0` | `0` | `docs/cli/matrices/submodule_v2_47.tsv` | `5` | `0` | `0` | `0` | `5` | no |
