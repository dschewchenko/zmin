...
| Written behavior rows | `716` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `640/716` | yes, row by row | exact written rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `158` | `128` | `0` | `0` | `30` | `82` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`716`** | **`640`** | **`0`** | **`0`** | **`76`** | **`407`** |
...
represented option pairs or `640/716` passing written rows as a Git support
percentage. The `640/716` number is audit progress for rows already written
...
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `37` | `33` | `0` | `0` | `4` | no |
