...
| Written behavior rows | `649` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `573/649` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `198` | `189` | `0` | `6` | `3` | `83` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`649`** | **`573`** | **`0`** | **`6`** | **`70`** | **`349`** |
...
represented option pairs or `573/649` passing written rows as a Git support
percentage. The `573/649` number is audit progress for rows already written
