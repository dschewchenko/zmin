...
| Commands with any matrix rows | `90/151` | no | audit rows exist for `add`, `apply`, `archive`, `bisect`, `blame`, `branch`, `bugreport`, `bundle`, `cat-file`, `check-attr`, `check-ignore`, `check-mailmap`, `check-ref-format`, `cherry`, `checkout`, `checkout-index`, `clean`, `clone`, `column`, `commit-graph`, `commit-tree`, `config`, `count-objects`, `credential`, `credential-cache`, `credential-store`, `describe`, `diff`, `diff-files`, `diff-index`, `diff-tree`, `difftool`, `fast-import`, `fetch`, `filter-branch`, `fmt-merge-msg`, `for-each-ref`, `grep`, `hash-object`, `http-fetch`, `index-pack`, `init`, `interpret-trailers`, `log`, `ls-files`, `ls-remote`, `ls-tree`, `mailinfo`, `mailsplit`, `maintenance`, `merge`, `merge-base`, `mktag`, `mktree`, `multi-pack-index`, `notes`, `p4`, `pack-objects`, `patch-id`, `prune`, `push`, `read-tree`, `rebase`, `reflog`, `remote`, `request-pull`, `replay`, `rerere`, `rev-list`, `rev-parse`, `rm`, `send-email`, `show`, `show-index`, `show-ref`, `shortlog`, `sparse-checkout`, `stash`, `status`, `stripspace`, `submodule`, `symbolic-ref`, `tag`, `unpack-file`, `update-server-info`, `var`, `verify-pack`, `version` and `worktree` |
| Git doc option pairs represented by rows | `492/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1945` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1636/1945` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1945` | no | written rows with incomplete parity |
| Open written rows | `1/1945` | no | written rows that still do not match stock Git |
| Invalid input rows | `308/1945` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `339` | `331` | `0` | `0` | `8` | `52` |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `465` | `398` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `106` | `72` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1945`** | **`1636`** | **`0`** | **`1`** | **`308`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `492/4632`
represented option pairs or `1636/1945` passing written rows as a Git support
percentage. The `1636/1945` number is audit progress for supported rows already
written down; `0/1945` rows are partial, `1/1945` rows are open and `308/1945`
...
| `apply` | `39` | `0` | `4` | `docs/cli/matrices/apply_v2_47.tsv` | `10` | `9` | `0` | `0` | `1` | no |
...
| `cat-file` | `21` | `0` | `8` | `docs/cli/matrices/cat_file_v2_47.tsv` | `24` | `16` | `0` | `0` | `8` | no |
...
| `clone` | `56` | `0` | `22` | `docs/cli/matrices/clone_v2_47.tsv` | `53` | `48` | `0` | `1` | `4` | no |
...
| `commit-tree` | `7` | `0` | `2` | `docs/cli/matrices/commit_tree_v2_47.tsv` | `3` | `3` | `0` | `0` | `0` | no |
...
| `diff` | `133` | `0` | `64` | `docs/cli/matrices/diff_v2_47.tsv` | `196` | `193` | `0` | `0` | `3` | no |
| `diff-files` | `130` | `0` | `4` | `docs/cli/matrices/diff_files_v2_47.tsv` | `6` | `6` | `0` | `0` | `0` | no |
...
| `interpret-trailers` | `24` | `0` | `6` | `docs/cli/matrices/interpret_trailers_v2_47.tsv` | `10` | `10` | `0` | `0` | `0` | no |
...
| `rev-list` | `165` | `0` | `9` | `docs/cli/matrices/rev_list_v2_47.tsv` | `17` | `17` | `0` | `0` | `0` | no |
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `69` | `63` | `0` | `0` | `6` | no |
...
| `show` | `143` | `0` | `10` | `docs/cli/matrices/show_v2_47.tsv` | `25` | `25` | `0` | `0` | `0` | no |
