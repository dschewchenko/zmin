...
| Written behavior rows | `2307` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1981/2307` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2307` | no | written rows with incomplete parity |
| Open written rows | `1/2307` | no | written rows that still do not match stock Git |
| Invalid input rows | `325/2307` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `250` | `208` | `0` | `0` | `42` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2307`** | **`1981`** | **`0`** | **`1`** | **`325`** | **`1018`** |
...
represented option pairs or `1981/2307` passing written rows as a Git support
percentage. The `1981/2307` number is audit progress for supported rows already
written down; `0/2307` rows are partial, `1/2307` rows are open and `325/2307`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `189` | `173` | `0` | `0` | `16` | no |
