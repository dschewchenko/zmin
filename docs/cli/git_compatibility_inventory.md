...
| Written behavior rows | `651` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `576/651` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `200` | `192` | `0` | `5` | `3` | `83` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`651`** | **`576`** | **`0`** | **`5`** | **`70`** | **`349`** |
...
represented option pairs or `576/651` passing written rows as a Git support
percentage. The `576/651` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `200` | `192` | `0` | `5` | `3` | no |
