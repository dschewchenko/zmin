...
| Written behavior rows | `823` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `727/823` | yes, row by row | supported-behavior rows with parity evidence |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `151` | `147` | `0` | `0` | `4` | `25` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`823`** | **`727`** | **`0`** | **`0`** | **`96`** | **`487`** |
...
represented option pairs or `727/823` passing written rows as a Git support
percentage. The `727/823` number is audit progress for supported rows already
written down; `96/823` additional rows are stock-compatible invalid inputs. It
...
| `log` | `282` | `0` | `32` | `docs/cli/matrices/log_v2_47.tsv` | `86` | `82` | `0` | `0` | `4` | no |
