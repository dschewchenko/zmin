...
| Git doc option pairs represented by rows | `230/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `831` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `731/831` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `7` | `4` | `0` | `0` | `3` | `59` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`831`** | **`731`** | **`0`** | **`0`** | **`100`** | **`495`** |
...
Never use `151/151` command presence, `4632` option spellings, `230/4632`
represented option pairs or `731/831` passing written rows as a Git support
percentage. The `731/831` number is audit progress for supported rows already
written down; `100/831` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `4` | `docs/cli/matrices/blame_v2_47.tsv` | `6` | `4` | `0` | `0` | `2` | no |
