...
| Git doc option pairs represented by rows | `253/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1094` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `823/1094` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1094` | no | written rows with incomplete parity |
| Open written rows | `1/1094` | no | written rows that still do not match stock Git |
| Invalid input rows | `270/1094` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Administration | `8` | `0` | `147` | `0` | `36` | `13` | `0` | `0` | `23` | `35` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1094`** | **`823`** | **`0`** | **`1`** | **`270`** | **`693`** |
...
Never use `151/151` command presence, `4632` option spellings, `253/4632`
represented option pairs or `823/1094` passing written rows as a Git support
percentage. The `823/1094` number is audit progress for supported rows already
written down; `0/1094` rows are partial, `1/1094` rows are open and `270/1094`
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `68` | `66` | `0` | `0` | `2` | no |
| `fast-import` | `25` | `0` | `1` | `docs/cli/matrices/fast_import_v2_47.tsv` | `7` | `4` | `0` | `0` | `3` | no |
| `filter-branch` | `37` | `0` | `2` | `docs/cli/matrices/filter_branch_v2_47.tsv` | `2` | `2` | `0` | `0` | `0` | no |
