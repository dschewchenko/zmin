...
- `docs/cli/matrices/filter_branch_v2_47.tsv` tracks the first
  `filter-branch --parent-filter` bad-output parity row.
...
| Commands with any matrix rows | `48/151` | no | audit rows exist for `add`, `archive`, `bisect`, `blame`, `branch`, `bundle`, `cat-file`, `clean`, `clone`, `column`, `commit-graph`, `config`, `diff`, `fast-import`, `fetch`, `filter-branch`, `for-each-ref`, `http-fetch`, `index-pack`, `init`, `log`, `ls-files`, `ls-remote`, `ls-tree`, `maintenance`, `merge`, `merge-base`, `multi-pack-index`, `notes`, `p4`, `pack-objects`, `prune`, `push`, `rebase`, `reflog`, `rerere`, `rev-parse`, `show-index`, `show-ref`, `sparse-checkout`, `stash`, `status`, `submodule`, `symbolic-ref`, `tag`, `verify-pack`, `version` and `worktree` |
| Git doc option pairs represented by rows | `251/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1074` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `811/1074` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1074` | no | written rows with incomplete parity |
| Open written rows | `1/1074` | no | written rows that still do not match stock Git |
| Invalid input rows | `262/1074` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Getting and Creating Projects | `2` | `0` | `66` | `0` | `7` | `5` | `0` | `1` | `1` | `2` |
| Basic Snapshotting | `9` | `0` | `371` | `0` | `83` | `66` | `0` | `0` | `17` | `99` |
| Branching and Merging | `9` | `0` | `581` | `0` | `84` | `55` | `0` | `0` | `29` | `45` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `300` | `283` | `0` | `0` | `17` | `159` |
| Inspection and Comparison | `7` | `0` | `774` | `0` | `153` | `147` | `0` | `0` | `6` | `26` |
...
| Administration | `8` | `0` | `147` | `0` | `35` | `12` | `0` | `0` | `23` | `34` |
| Server Admin | `2` | `0` | `30` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| Plumbing Commands | `20` | `0` | `644` | `0` | `201` | `151` | `0` | `0` | `50` | `116` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `48` | `21` | `0` | `0` | `27` | `39` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1074`** | **`811`** | **`0`** | **`1`** | **`262`** | **`683`** |
...
Never use `151/151` command presence, `4632` option spellings, `251/4632`
represented option pairs or `811/1074` passing written rows as a Git support
percentage. The `811/1074` number is audit progress for supported rows already
written down; `0/1074` rows are partial, `1/1074` rows are open and `262/1074`
...
| --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `add` | `34` | `0` | `0` | `docs/cli/matrices/add_v2_47.tsv` | `1` | `0` | `0` | `0` | `1` | no |
...
| `cat-file` | `21` | `0` | `1` | `docs/cli/matrices/cat_file_v2_47.tsv` | `7` | `0` | `0` | `0` | `7` | no |
| `clean` | `13` | `0` | `3` | `docs/cli/matrices/clean_v2_47.tsv` | `12` | `8` | `0` | `0` | `4` | no |
| `clone` | `56` | `0` | `3` | `docs/cli/matrices/clone_v2_47.tsv` | `5` | `3` | `0` | `1` | `1` | no |
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `76` | `66` | `0` | `0` | `10` | no |
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `291` | `283` | `0` | `0` | `8` | no |
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `66` | `65` | `0` | `0` | `1` | no |
| `fast-import` | `25` | `0` | `1` | `docs/cli/matrices/fast_import_v2_47.tsv` | `7` | `4` | `0` | `0` | `3` | no |
| `filter-branch` | `37` | `0` | `1` | `docs/cli/matrices/filter_branch_v2_47.tsv` | `1` | `1` | `0` | `0` | `0` | no |
...
| `ls-remote` | `16` | `0` | `0` | `docs/cli/matrices/ls_remote_v2_47.tsv` | `1` | `0` | `0` | `0` | `1` | no |
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `24` | `20` | `0` | `0` | `4` | no |
