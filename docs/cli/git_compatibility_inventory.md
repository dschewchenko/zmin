...
| Written behavior rows | `955` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `756/955` | yes, row by row | supported-behavior rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `185` | `145` | `0` | `0` | `40` | `102` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `6` | `2` | `0` | `0` | `4` | `5` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`955`** | **`756`** | **`0`** | **`0`** | **`199`** | **`605`** |
...
represented option pairs or `756/955` passing written rows as a Git support
percentage. The `756/955` number is audit progress for supported rows already
written down; `199/955` additional rows are stock-compatible invalid inputs. It
...
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `67` | `52` | `0` | `0` | `15` | no |
