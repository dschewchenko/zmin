...
| Written behavior rows | `839` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `732/839` | yes, row by row | supported-behavior rows with parity evidence |
...
| Administration | `8` | `0` | `147` | `0` | `4` | `0` | `0` | `0` | `4` | `20` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`839`** | **`732`** | **`0`** | **`0`** | **`107`** | **`503`** |
...
represented option pairs or `732/839` passing written rows as a Git support
percentage. The `732/839` number is audit progress for supported rows already
written down; `107/839` additional rows are stock-compatible invalid inputs. It
