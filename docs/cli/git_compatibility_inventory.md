...
| Written behavior rows | `2105` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1794/2105` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2105` | no | written rows with incomplete parity |
| Open written rows | `1/2105` | no | written rows that still do not match stock Git |
| Invalid input rows | `310/2105` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `383` | `375` | `0` | `0` | `8` | `52` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2105`** | **`1794`** | **`0`** | **`1`** | **`310`** | **`1018`** |
...
represented option pairs or `1794/2105` passing written rows as a Git support
percentage. The `1794/2105` number is audit progress for supported rows already
written down; `0/2105` rows are partial, `1/2105` rows are open and `310/2105`
...
| `diff` | `133` | `0` | `69` | `docs/cli/matrices/diff_v2_47.tsv` | `226` | `223` | `0` | `0` | `3` | no |
