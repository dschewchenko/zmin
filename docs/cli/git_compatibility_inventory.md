...
| Written behavior rows | `795` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `719/795` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`795`** | **`719`** | **`0`** | **`0`** | **`76`** | **`463`** |
...
represented option pairs or `719/795` passing written rows as a Git support
percentage. The `719/795` number is audit progress for rows already written
...
| `config` | `243` | `0` | `17` | `docs/cli/matrices/config_v2_47.tsv` | `59` | `50` | `0` | `0` | `9` | no |
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `68` | `64` | `0` | `0` | `4` | no |
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `289` | `283` | `0` | `0` | `6` | no |
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `60` | `60` | `0` | `0` | `0` | no |
