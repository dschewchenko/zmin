...
| Written behavior rows | `801` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `725/801` | yes, row by row | exact written rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `69` | `65` | `0` | `0` | `4` | `84` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`801`** | **`725`** | **`0`** | **`0`** | **`76`** | **`469`** |
...
represented option pairs or `725/801` passing written rows as a Git support
percentage. The `725/801` number is audit progress for rows already written
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `69` | `65` | `0` | `0` | `4` | no |
