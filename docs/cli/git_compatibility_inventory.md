...
| Written behavior rows | `2274` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1957/2274` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2274` | no | written rows with incomplete parity |
| Open written rows | `1/2274` | no | written rows that still do not match stock Git |
| Invalid input rows | `316/2274` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `217` | `184` | `0` | `0` | `33` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2274`** | **`1957`** | **`0`** | **`1`** | **`316`** | **`1018`** |
...
represented option pairs or `1957/2274` passing written rows as a Git support
percentage. The `1957/2274` number is audit progress for supported rows already
written down; `0/2274` rows are partial, `1/2274` rows are open and `316/2274`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `156` | `149` | `0` | `0` | `7` | no |
