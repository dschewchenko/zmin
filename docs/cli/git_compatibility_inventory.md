...
| Written behavior rows | `784` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `708/784` | yes, row by row | exact written rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `67` | `63` | `0` | `0` | `4` | `74` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`784`** | **`708`** | **`0`** | **`0`** | **`76`** | **`452`** |
...
represented option pairs or `708/784` passing written rows as a Git support
percentage. The `708/784` number is audit progress for rows already written
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `67` | `63` | `0` | `0` | `4` | no |
