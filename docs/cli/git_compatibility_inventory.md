...
| Written behavior rows | `2724` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2336/2724` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2724` | no | written rows with incomplete parity |
| Open written rows | `1/2724` | no | written rows that still do not match stock Git |
| Invalid input rows | `387/2724` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `535` | `468` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `166` | `129` | `0` | `0` | `37` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2724`** | **`2336`** | **`0`** | **`1`** | **`387`** | **`1018`** |
...
represented option pairs or `2336/2724` passing written rows as a Git support
percentage. The `2336/2724` number is audit progress for supported rows already
written down; `0/2724` rows are partial, `1/2724` rows are open and `387/2724`
