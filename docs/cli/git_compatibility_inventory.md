...
| Written behavior rows | `2179` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1863/2179` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2179` | no | written rows with incomplete parity |
| Open written rows | `1/2179` | no | written rows that still do not match stock Git |
| Invalid input rows | `315/2179` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `122` | `90` | `0` | `0` | `32` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2179`** | **`1863`** | **`0`** | **`1`** | **`315`** | **`1018`** |
...
represented option pairs or `1863/2179` passing written rows as a Git support
percentage. The `1863/2179` number is audit progress for supported rows already
written down; `0/2179` rows are partial, `1/2179` rows are open and `315/2179`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `61` | `55` | `0` | `0` | `6` | no |
