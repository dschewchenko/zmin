...
| Written behavior rows | `668` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `595/668` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `208` | `203` | `0` | `2` | `3` | `92` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`668`** | **`595`** | **`0`** | **`2`** | **`71`** | **`358`** |
...
represented option pairs or `595/668` passing written rows as a Git support
percentage. The `595/668` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `208` | `203` | `0` | `2` | `3` | no |
...
parent fetch whose initialized submodule remote is local:
