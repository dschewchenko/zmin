...
| Written behavior rows | `999` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `770/999` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/999` | no | written rows with incomplete parity |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `25` | `7` | `1` | `0` | `17` | `27` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`999`** | **`770`** | **`1`** | **`0`** | **`228`** | **`647`** |
...
represented option pairs or `770/999` passing written rows as a Git support
percentage. The `770/999` number is audit progress for supported rows already
written down; `1/999` row is partial and `228/999` additional rows are
...
| `fast-import` | `25` | `0` | `1` | `docs/cli/matrices/fast_import_v2_47.tsv` | `1` | `0` | `1` | `0` | `0` | no |
