...
| Commands with any matrix rows | `24/151` | no | audit rows exist for `archive`, `bisect`, `blame`, `branch`, `cat-file`, `column`, `config`, `status`, `fetch`, `diff`, `log`, `for-each-ref`, `ls-files`, `ls-tree`, `merge-base`, `notes`, `reflog`, `rerere`, `rev-parse`, `show-ref`, `submodule`, `symbolic-ref`, `tag` and `version` |
| Git doc option pairs represented by rows | `229/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `830` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `730/830` | yes, row by row | supported-behavior rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `76` | `66` | `0` | `0` | `10` | `91` |
| Branching and Merging | `9` | `0` | `581` | `0` | `58` | `35` | `0` | `0` | `23` | `30` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `293` | `283` | `0` | `0` | `10` | `155` |
| Inspection and Comparison | `7` | `0` | `774` | `0` | `152` | `147` | `0` | `0` | `5` | `26` |
| Patching | `5` | `0` | `333` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| Debugging | `3` | `0` | `132` | `0` | `6` | `3` | `0` | `0` | `3` | `58` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`830`** | **`730`** | **`0`** | **`0`** | **`100`** | **`494`** |
...
Never use `151/151` command presence, `4632` option spellings, `229/4632`
represented option pairs or `730/830` passing written rows as a Git support
percentage. The `730/830` number is audit progress for supported rows already
written down; `100/830` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `3` | `docs/cli/matrices/blame_v2_47.tsv` | `5` | `3` | `0` | `0` | `2` | no |
...
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `59` | `51` | `0` | `0` | `8` | no |
...
| `submodule` | `35` | `0` | `0` | `docs/cli/matrices/submodule_v2_47.tsv` | `4` | `0` | `0` | `0` | `4` | no |
