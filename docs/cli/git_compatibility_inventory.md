...
| Written behavior rows | `1785` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1482/1785` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1785` | no | written rows with incomplete parity |
| Open written rows | `1/1785` | no | written rows that still do not match stock Git |
| Invalid input rows | `301/1785` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `400` | `335` | `0` | `0` | `65` | `160` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `106` | `72` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1785`** | **`1482`** | **`0`** | **`1`** | **`302`** | **`922`** |
...
represented option pairs or `1482/1785` passing written rows as a Git support
percentage. The `1482/1785` number is audit progress for supported rows already
written down; `0/1785` rows are partial, `1/1785` rows are open and `301/1785`
...
| `ls-files` | `42` | `0` | `29` | `docs/cli/matrices/ls_files_v2_47.tsv` | `144` | `124` | `0` | `0` | `20` | no |
