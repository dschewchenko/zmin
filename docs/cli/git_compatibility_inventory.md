...
| Written behavior rows | `2298` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1976/2298` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2298` | no | written rows with incomplete parity |
| Open written rows | `1/2298` | no | written rows that still do not match stock Git |
| Invalid input rows | `321/2298` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `241` | `203` | `0` | `0` | `38` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2298`** | **`1976`** | **`0`** | **`1`** | **`321`** | **`1018`** |
...
represented option pairs or `1976/2298` passing written rows as a Git support
percentage. The `1976/2298` number is audit progress for supported rows already
written down; `0/2298` rows are partial, `1/2298` rows are open and `321/2298`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `180` | `168` | `0` | `0` | `12` | no |
