...
| Written behavior rows | `695` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `621/695` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `235` | `229` | `0` | `2` | `4` | `126` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`695`** | **`621`** | **`0`** | **`2`** | **`72`** | **`392`** |
...
represented option pairs or `621/695` passing written rows as a Git support
percentage. The `621/695` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `235` | `229` | `0` | `2` | `4` | no |
