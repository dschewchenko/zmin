...
| Written behavior rows | `761` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `685/761` | yes, row by row | exact written rows with parity evidence |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `138` | `135` | `0` | `0` | `3` | `23` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`761`** | **`685`** | **`0`** | **`0`** | **`76`** | **`429`** |
...
represented option pairs or `685/761` passing written rows as a Git support
percentage. The `685/761` number is audit progress for rows already written
