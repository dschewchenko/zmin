...
| Written behavior rows | `2008` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1697/2008` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2008` | no | written rows with incomplete parity |
| Open written rows | `1/2008` | no | written rows that still do not match stock Git |
| Invalid input rows | `310/2008` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Patching | `5` | `0` | `333` | `0` | `15` | `13` | `0` | `0` | `2` | `11` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2008`** | **`1697`** | **`0`** | **`1`** | **`310`** | **`1018`** |
...
represented option pairs or `1697/2008` passing written rows as a Git support
percentage. The `1697/2008` number is audit progress for supported rows already
written down; `0/2008` rows are partial, `1/2008` rows are open and `310/2008`
...
| `apply` | `39` | `0` | `4` | `docs/cli/matrices/apply_v2_47.tsv` | `14` | `13` | `0` | `0` | `1` | no |
