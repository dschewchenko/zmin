...
| Written behavior rows | `1868` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1561/1868` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1868` | no | written rows with incomplete parity |
| Open written rows | `1/1868` | no | written rows that still do not match stock Git |
| Invalid input rows | `306/1868` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `418` | `353` | `0` | `0` | `65` | `181` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `106` | `72` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1868`** | **`1561`** | **`0`** | **`1`** | **`306`** | **`1004`** |
...
represented option pairs or `1561/1868` passing written rows as a Git support
percentage. The `1561/1868` number is audit progress for supported rows already
written down; `0/1868` rows are partial, `1/1868` rows are open and `306/1868`
