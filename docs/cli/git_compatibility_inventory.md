...
| Written behavior rows | `2562` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2187/2562` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2562` | no | written rows with incomplete parity |
| Open written rows | `1/2562` | no | written rows that still do not match stock Git |
| Invalid input rows | `374/2562` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `379` | `354` | `0` | `0` | `25` | `160` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2562`** | **`2187`** | **`0`** | **`1`** | **`374`** | **`1018`** |
...
represented option pairs or `2187/2562` passing written rows as a Git support
percentage. The `2187/2562` number is audit progress for supported rows already
written down; `0/2562` rows are partial, `1/2562` rows are open and `374/2562`
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `316` | `306` | `0` | `0` | `10` | no |
