...
| Written behavior rows | `1772` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1470/1772` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1772` | no | written rows with incomplete parity |
| Open written rows | `1/1772` | no | written rows that still do not match stock Git |
| Invalid input rows | `301/1772` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `387` | `323` | `0` | `0` | `64` | `145` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `106` | `72` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1772`** | **`1470`** | **`0`** | **`1`** | **`301`** | **`907`** |
...
represented option pairs or `1470/1772` passing written rows as a Git support
percentage. The `1470/1772` number is audit progress for supported rows already
written down; `0/1772` rows are partial, `1/1772` rows are open and `301/1772`
...
| `ls-files` | `42` | `0` | `28` | `docs/cli/matrices/ls_files_v2_47.tsv` | `131` | `112` | `0` | `0` | `19` | no |
