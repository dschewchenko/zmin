...
| Written behavior rows | `765` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `689/765` | yes, row by row | exact written rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `164` | `134` | `0` | `0` | `30` | `88` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`765`** | **`689`** | **`0`** | **`0`** | **`76`** | **`433`** |
...
represented option pairs or `689/765` passing written rows as a Git support
percentage. The `689/765` number is audit progress for rows already written
...
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `41` | `37` | `0` | `0` | `4` | no |
