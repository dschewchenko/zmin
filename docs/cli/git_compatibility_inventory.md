...
| Written behavior rows | `872` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/872` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `22` | `8` | `0` | `0` | `14` | `74` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`872`** | **`742`** | **`0`** | **`0`** | **`130`** | **`522`** |
...
represented option pairs or `742/872` passing written rows as a Git support
percentage. The `742/872` number is audit progress for supported rows already
written down; `130/872` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `21` | `8` | `0` | `0` | `13` | no |
