...
| Written behavior rows | `242` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `227/242` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `182` | `171` | `0` | `9` | `2` | `71` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`242`** | **`227`** | **`0`** | **`9`** | **`6`** | **`324`** |
...
represented option pairs or `227/242` passing written rows as a Git support
percentage. The `227/242` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `182` | `171` | `0` | `9` | `2` | no |
...
explicit local/file locations in existing shallow repos.
