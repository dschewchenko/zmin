...
| Written behavior rows | `861` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `739/861` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `11` | `5` | `0` | `0` | `6` | `63` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`861`** | **`739`** | **`0`** | **`0`** | **`122`** | **`511`** |
...
represented option pairs or `739/861` passing written rows as a Git support
percentage. The `739/861` number is audit progress for supported rows already
written down; `122/861` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `10` | `5` | `0` | `0` | `5` | no |
