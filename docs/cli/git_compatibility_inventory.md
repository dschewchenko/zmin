...
| Written behavior rows | `2606` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2230/2606` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2606` | no | written rows with incomplete parity |
| Open written rows | `1/2606` | no | written rows that still do not match stock Git |
| Invalid input rows | `375/2606` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Administration | `8` | `0` | `147` | `0` | `129` | `69` | `0` | `0` | `60` | `58` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2606`** | **`2230`** | **`0`** | **`1`** | **`375`** | **`1018`** |
...
represented option pairs or `2230/2606` passing written rows as a Git support
percentage. The `2230/2606` number is audit progress for supported rows already
written down; `0/2606` rows are partial, `1/2606` rows are open and `375/2606`
...
| `maintenance` | `14` | `0` | `3` | `docs/cli/matrices/maintenance_v2_47.tsv` | `9` | `4` | `0` | `0` | `5` | no |
