...
| Written behavior rows | `834` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `732/834` | yes, row by row | supported-behavior rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `78` | `66` | `0` | `0` | `12` | `93` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`834`** | **`732`** | **`0`** | **`0`** | **`102`** | **`498`** |
...
represented option pairs or `732/834` passing written rows as a Git support
percentage. The `732/834` number is audit progress for supported rows already
written down; `102/834` additional rows are stock-compatible invalid inputs. It
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `72` | `66` | `0` | `0` | `6` | no |
