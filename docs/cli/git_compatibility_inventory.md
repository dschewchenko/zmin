...
| Written behavior rows | `682` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `608/682` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `222` | `216` | `0` | `2` | `4` | `106` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`682`** | **`608`** | **`0`** | **`2`** | **`72`** | **`372`** |
...
represented option pairs or `608/682` passing written rows as a Git support
percentage. The `608/682` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `222` | `216` | `0` | `2` | `4` | no |
