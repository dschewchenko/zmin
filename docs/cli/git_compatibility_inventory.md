...
| Written behavior rows | `1485` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1193/1485` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1485` | no | written rows with incomplete parity |
| Open written rows | `1/1485` | no | written rows that still do not match stock Git |
| Invalid input rows | `291/1485` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `126` | `113` | `0` | `0` | `13` | `8` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1485`** | **`1193`** | **`0`** | **`1`** | **`291`** | **`721`** |
...
represented option pairs or `1193/1485` passing written rows as a Git support
percentage. The `1193/1485` number is audit progress for supported rows already
written down; `0/1485` rows are partial, `1/1485` rows are open and `291/1485`
...
| `config` | `243` | `0` | `17` | `docs/cli/matrices/config_v2_47.tsv` | `114` | `104` | `0` | `0` | `10` | no |
