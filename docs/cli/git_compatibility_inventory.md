...
| Written behavior rows | `998` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `770/998` | yes, row by row | supported-behavior rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `296` | `283` | `0` | `0` | `13` | `158` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`998`** | **`770`** | **`0`** | **`0`** | **`228`** | **`647`** |
...
represented option pairs or `770/998` passing written rows as a Git support
percentage. The `770/998` number is audit progress for supported rows already
written down; `228/998` additional rows are stock-compatible invalid inputs. It
