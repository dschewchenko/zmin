...
| Written behavior rows | `789` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `713/789` | yes, row by row | exact written rows with parity evidence |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `58` | `49` | `0` | `0` | `9` | `7` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `171` | `141` | `0` | `0` | `30` | `95` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`789`** | **`713`** | **`0`** | **`0`** | **`76`** | **`457`** |
...
represented option pairs or `713/789` passing written rows as a Git support
percentage. The `713/789` number is audit progress for rows already written
...
| `config` | `243` | `0` | `17` | `docs/cli/matrices/config_v2_47.tsv` | `58` | `49` | `0` | `0` | `9` | no |
...
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `57` | `49` | `0` | `0` | `8` | no |
