...
| Commands with any matrix rows | `79/151` | no | audit rows exist for `add`, `apply`, `archive`, `bisect`, `blame`, `branch`, `bugreport`, `bundle`, `cat-file`, `check-attr`, `check-ignore`, `check-mailmap`, `check-ref-format`, `cherry`, `checkout`, `checkout-index`, `clean`, `clone`, `column`, `commit-graph`, `config`, `credential`, `credential-cache`, `credential-store`, `describe`, `diff`, `diff-files`, `diff-index`, `diff-tree`, `fast-import`, `fetch`, `filter-branch`, `fmt-merge-msg`, `for-each-ref`, `grep`, `http-fetch`, `index-pack`, `init`, `interpret-trailers`, `log`, `ls-files`, `ls-remote`, `ls-tree`, `mailinfo`, `mailsplit`, `maintenance`, `merge`, `merge-base`, `multi-pack-index`, `notes`, `p4`, `pack-objects`, `patch-id`, `prune`, `push`, `rebase`, `reflog`, `remote`, `request-pull`, `rerere`, `rev-list`, `rev-parse`, `rm`, `send-email`, `show-index`, `show-ref`, `shortlog`, `sparse-checkout`, `stash`, `status`, `stripspace`, `submodule`, `symbolic-ref`, `tag`, `var`, `verify-pack`, `version` and `worktree` |
| Git doc option pairs represented by rows | `442/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1757` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1457/1757` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1757` | no | written rows with incomplete parity |
| Open written rows | `1/1757` | no | written rows that still do not match stock Git |
| Invalid input rows | `299/1757` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Getting and Creating Projects | `2` | `0` | `66` | `0` | `51` | `48` | `0` | `1` | `2` | `45` |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `265` | `258` | `0` | `0` | `7` | `42` |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `376` | `313` | `0` | `0` | `63` | `131` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `102` | `69` | `0` | `0` | `33` | `98` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1757`** | **`1457`** | **`0`** | **`1`** | **`299`** | **`889`** |
...
Never use `151/151` command presence, `4632` option spellings, `442/4632`
represented option pairs or `1457/1757` passing written rows as a Git support
percentage. The `1457/1757` number is audit progress for supported rows already
written down; `0/1757` rows are partial, `1/1757` rows are open and `299/1757`
...
| `diff` | `133` | `0` | `56` | `docs/cli/matrices/diff_v2_47.tsv` | `151` | `149` | `0` | `0` | `2` | no |
...
| `ls-files` | `42` | `0` | `28` | `docs/cli/matrices/ls_files_v2_47.tsv` | `120` | `102` | `0` | `0` | `18` | no |
...
| `rev-list` | `165` | `0` | `8` | `docs/cli/matrices/rev_list_v2_47.tsv` | `10` | `10` | `0` | `0` | `0` | no |
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `64` | `58` | `0` | `0` | `6` | no |
