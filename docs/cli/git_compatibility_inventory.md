...
| Git doc option pairs represented by rows | `221/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `713` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `639/713` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `250` | `244` | `0` | `0` | `6` | `135` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `155` | `127` | `0` | `0` | `28` | `79` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`713`** | **`639`** | **`0`** | **`0`** | **`74`** | **`404`** |
...
Never use `151/151` command presence, `4632` option spellings, `221/4632`
represented option pairs or `639/713` passing written rows as a Git support
percentage. The `639/713` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `250` | `244` | `0` | `0` | `6` | no |
...
| `rev-parse` | `72` | `0` | `22` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `34` | `32` | `0` | `0` | `2` | no |
