...
| Written behavior rows | `774` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `698/774` | yes, row by row | exact written rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `65` | `61` | `0` | `0` | `4` | `70` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`774`** | **`698`** | **`0`** | **`0`** | **`76`** | **`442`** |
...
represented option pairs or `698/774` passing written rows as a Git support
percentage. The `698/774` number is audit progress for rows already written
