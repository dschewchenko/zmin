...
| Written behavior rows | `1008` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `770/1008` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1008` | no | written rows with incomplete parity |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `32` | `7` | `1` | `0` | `24` | `28` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1008`** | **`770`** | **`1`** | **`0`** | **`237`** | **`650`** |
...
represented option pairs or `770/1008` passing written rows as a Git support
percentage. The `770/1008` number is audit progress for supported rows already
written down; `1/1008` row is partial and `237/1008` additional rows are
