...
| Written behavior rows | `946` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/946` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `96` | `21` | `0` | `0` | `75` | `148` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`946`** | **`755`** | **`0`** | **`0`** | **`191`** | **`596`** |
...
represented option pairs or `755/946` passing written rows as a Git support
percentage. The `755/946` number is audit progress for supported rows already
written down; `191/946` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `95` | `21` | `0` | `0` | `74` | no |
