...
| Written behavior rows | `876` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/876` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `26` | `8` | `0` | `0` | `18` | `78` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`876`** | **`742`** | **`0`** | **`0`** | **`134`** | **`526`** |
...
represented option pairs or `742/876` passing written rows as a Git support
percentage. The `742/876` number is audit progress for supported rows already
written down; `134/876` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `25` | `8` | `0` | `0` | `17` | no |
