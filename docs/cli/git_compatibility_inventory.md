...
| Written behavior rows | `835` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `732/835` | yes, row by row | supported-behavior rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `79` | `66` | `0` | `0` | `13` | `94` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`835`** | **`732`** | **`0`** | **`0`** | **`103`** | **`499`** |
...
represented option pairs or `732/835` passing written rows as a Git support
percentage. The `732/835` number is audit progress for supported rows already
written down; `103/835` additional rows are stock-compatible invalid inputs. It
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `73` | `66` | `0` | `0` | `7` | no |
