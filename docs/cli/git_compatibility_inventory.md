...
| Written behavior rows | `644` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `567/644` | yes, row by row | exact written rows with parity evidence |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `134` | `132` | `0` | `0` | `2` | `21` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`644`** | **`567`** | **`0`** | **`8`** | **`69`** | **`349`** |
...
represented option pairs or `567/644` passing written rows as a Git support
percentage. The `567/644` number is audit progress for rows already written
...
| `log` | `282` | `0` | `32` | `docs/cli/matrices/log_v2_47.tsv` | `81` | `79` | `0` | `0` | `2` | no |
