...
| Written behavior rows | `628` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `552/628` | yes, row by row | exact written rows with parity evidence |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `118` | `117` | `0` | `0` | `1` | `17` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`628`** | **`552`** | **`0`** | **`8`** | **`68`** | **`345`** |
...
represented option pairs or `552/628` passing written rows as a Git support
percentage. The `552/628` number is audit progress for rows already written
...
| `log` | `282` | `0` | `32` | `docs/cli/matrices/log_v2_47.tsv` | `65` | `64` | `0` | `0` | `1` | no |
