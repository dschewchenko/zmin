...
| Written behavior rows | `878` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/878` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `28` | `8` | `0` | `0` | `20` | `80` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`878`** | **`742`** | **`0`** | **`0`** | **`136`** | **`528`** |
...
represented option pairs or `742/878` passing written rows as a Git support
percentage. The `742/878` number is audit progress for supported rows already
written down; `136/878` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `27` | `8` | `0` | `0` | `19` | no |
