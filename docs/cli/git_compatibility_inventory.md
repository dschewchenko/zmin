...
| Written behavior rows | `928` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/928` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `78` | `21` | `0` | `0` | `57` | `130` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`928`** | **`755`** | **`0`** | **`0`** | **`173`** | **`578`** |
...
represented option pairs or `755/928` passing written rows as a Git support
percentage. The `755/928` number is audit progress for supported rows already
written down; `173/928` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `77` | `21` | `0` | `0` | `56` | no |
