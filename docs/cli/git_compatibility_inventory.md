...
| Written behavior rows | `937` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/937` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `87` | `21` | `0` | `0` | `66` | `139` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`937`** | **`755`** | **`0`** | **`0`** | **`182`** | **`587`** |
...
represented option pairs or `755/937` passing written rows as a Git support
percentage. The `755/937` number is audit progress for supported rows already
written down; `182/937` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `86` | `21` | `0` | `0` | `65` | no |
