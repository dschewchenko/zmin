...
| Written behavior rows | `195` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `180/195` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `309` | `135` | `124` | `0` | `9` | `2` | `24` |
...
| **Git 2.47 unique total** | **`151`** | **`4632`** | **`195`** | **`180`** | **`0`** | **`9`** | **`6`** | **`277`** |
...
Never use `151/151` command presence, `4632` option spellings or `180/195`
passing written rows as a Git support percentage. The `180/195` number is audit
...
| `fetch` | `73` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `135` | `124` | `0` | `9` | `2` | no |
