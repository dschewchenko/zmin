...
| Written behavior rows | `918` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `753/918` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `68` | `19` | `0` | `0` | `49` | `120` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`918`** | **`753`** | **`0`** | **`0`** | **`165`** | **`568`** |
...
represented option pairs or `753/918` passing written rows as a Git support
percentage. The `753/918` number is audit progress for supported rows already
written down; `165/918` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `67` | `19` | `0` | `0` | `48` | no |
