...
| Written behavior rows | `2354` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2012/2354` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2354` | no | written rows with incomplete parity |
| Open written rows | `1/2354` | no | written rows that still do not match stock Git |
| Invalid input rows | `341/2354` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Administration | `8` | `0` | `147` | `0` | `105` | `65` | `0` | `0` | `40` | `58` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2354`** | **`2012`** | **`0`** | **`1`** | **`341`** | **`1018`** |
...
represented option pairs or `2012/2354` passing written rows as a Git support
percentage. The `2012/2354` number is audit progress for supported rows already
written down; `0/2354` rows are partial, `1/2354` rows are open and `341/2354`
...
| `fsck` | `17` | `0` | `0` | `docs/cli/matrices/fsck_v2_47.tsv` | `15` | `0` | `0` | `0` | `15` | no |
