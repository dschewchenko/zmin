...
| Git doc option pairs represented by rows | `533/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2075` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1764/2075` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2075` | no | written rows with incomplete parity |
| Open written rows | `1/2075` | no | written rows that still do not match stock Git |
| Invalid input rows | `310/2075` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Debugging | `3` | `0` | `132` | `0` | `154` | `73` | `0` | `0` | `81` | `166` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2075`** | **`1764`** | **`0`** | **`1`** | **`310`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `533/4632`
represented option pairs or `1764/2075` passing written rows as a Git support
percentage. The `1764/2075` number is audit progress for supported rows already
written down; `0/2075` rows are partial, `1/2075` rows are open and `310/2075`
...
| `blame` | `39` | `0` | `23` | `docs/cli/matrices/blame_v2_47.tsv` | `141` | `61` | `0` | `0` | `80` | no |
