...
| Written behavior rows | `930` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/930` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `80` | `21` | `0` | `0` | `59` | `132` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`930`** | **`755`** | **`0`** | **`0`** | **`175`** | **`580`** |
...
represented option pairs or `755/930` passing written rows as a Git support
percentage. The `755/930` number is audit progress for supported rows already
written down; `175/930` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `79` | `21` | `0` | `0` | `58` | no |
