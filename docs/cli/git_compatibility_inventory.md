...
| Written behavior rows | `776` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `700/776` | yes, row by row | exact written rows with parity evidence |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `55` | `46` | `0` | `0` | `9` | `4` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`776`** | **`700`** | **`0`** | **`0`** | **`76`** | **`444`** |
...
represented option pairs or `700/776` passing written rows as a Git support
percentage. The `700/776` number is audit progress for rows already written
...
| `config` | `243` | `0` | `17` | `docs/cli/matrices/config_v2_47.tsv` | `55` | `46` | `0` | `0` | `9` | no |
