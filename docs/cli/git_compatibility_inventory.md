...
| Git doc option pairs represented by rows | `228/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `828` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `728/828` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `4` | `1` | `0` | `0` | `3` | `56` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`828`** | **`728`** | **`0`** | **`0`** | **`100`** | **`492`** |
...
Never use `151/151` command presence, `4632` option spellings, `228/4632`
represented option pairs or `728/828` passing written rows as a Git support
percentage. The `728/828` number is audit progress for supported rows already
written down; `100/828` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `2` | `docs/cli/matrices/blame_v2_47.tsv` | `3` | `1` | `0` | `0` | `2` | no |
