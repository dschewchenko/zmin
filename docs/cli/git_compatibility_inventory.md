...
| Written behavior rows | `778` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `702/778` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`778`** | **`702`** | **`0`** | **`0`** | **`76`** | **`446`** |
...
represented option pairs or `702/778` passing written rows as a Git support
percentage. The `702/778` number is audit progress for rows already written
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `56` | `56` | `0` | `0` | `0` | no |
