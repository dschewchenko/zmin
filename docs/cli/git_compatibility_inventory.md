...
- `docs/cli/matrices/remote_v2_47.tsv` tracks the first `remote` add, list,
  verbose, get-url, set-url, rename, remove, show and prune variants.
...
| Written behavior rows | `1447` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1160/1447` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1447` | no | written rows with incomplete parity |
| Open written rows | `1/1447` | no | written rows that still do not match stock Git |
| Invalid input rows | `286/1447` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `327` | `307` | `0` | `0` | `20` | `160` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1447`** | **`1160`** | **`0`** | **`1`** | **`286`** | **`721`** |
...
represented option pairs or `1160/1447` passing written rows as a Git support
percentage. The `1160/1447` number is audit progress for supported rows already
written down; `0/1447` rows are partial, `1/1447` rows are open and `286/1447`
...
| `remote` | `23` | `0` | `1` | `docs/cli/matrices/remote_v2_47.tsv` | `13` | `12` | `0` | `0` | `1` | no |
