...
| Written behavior rows | `1451` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1163/1451` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1451` | no | written rows with incomplete parity |
| Open written rows | `1/1451` | no | written rows that still do not match stock Git |
| Invalid input rows | `287/1451` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `331` | `310` | `0` | `0` | `21` | `160` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1451`** | **`1163`** | **`0`** | **`1`** | **`287`** | **`721`** |
...
represented option pairs or `1163/1451` passing written rows as a Git support
percentage. The `1163/1451` number is audit progress for supported rows already
written down; `0/1451` rows are partial, `1/1451` rows are open and `287/1451`
...
| `remote` | `23` | `0` | `1` | `docs/cli/matrices/remote_v2_47.tsv` | `17` | `15` | `0` | `0` | `2` | no |
