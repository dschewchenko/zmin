...
| Written behavior rows | `1001` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `770/1001` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1001` | no | written rows with incomplete parity |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `27` | `7` | `1` | `0` | `19` | `27` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1001`** | **`770`** | **`1`** | **`0`** | **`230`** | **`647`** |
...
represented option pairs or `770/1001` passing written rows as a Git support
percentage. The `770/1001` number is audit progress for supported rows already
written down; `1/1001` row is partial and `230/1001` additional rows are
...
| `fast-import` | `25` | `0` | `1` | `docs/cli/matrices/fast_import_v2_47.tsv` | `3` | `0` | `1` | `0` | `2` | no |
