...
| Written behavior rows | `643` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `566/643` | yes, row by row | exact written rows with parity evidence |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `133` | `131` | `0` | `0` | `2` | `21` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`643`** | **`566`** | **`0`** | **`8`** | **`69`** | **`349`** |
...
represented option pairs or `566/643` passing written rows as a Git support
percentage. The `566/643` number is audit progress for rows already written
...
| `log` | `282` | `0` | `32` | `docs/cli/matrices/log_v2_47.tsv` | `80` | `78` | `0` | `0` | `2` | no |
