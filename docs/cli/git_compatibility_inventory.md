...
| Git doc option pairs represented by rows | `446/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1786` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1483/1786` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1786` | no | written rows with incomplete parity |
| Open written rows | `1/1786` | no | written rows that still do not match stock Git |
| Invalid input rows | `302/1786` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `401` | `336` | `0` | `0` | `65` | `164` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `106` | `72` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1786`** | **`1483`** | **`0`** | **`1`** | **`302`** | **`926`** |
...
Never use `151/151` command presence, `4632` option spellings, `446/4632`
represented option pairs or `1483/1786` passing written rows as a Git support
percentage. The `1483/1786` number is audit progress for supported rows already
written down; `0/1786` rows are partial, `1/1786` rows are open and `302/1786`
...
| `ls-files` | `42` | `0` | `29` | `docs/cli/matrices/ls_files_v2_47.tsv` | `145` | `125` | `0` | `0` | `20` | no |
