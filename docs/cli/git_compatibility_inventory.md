...
| Written behavior rows | `853` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `737/853` | yes, row by row | supported-behavior rows with parity evidence |
...
| Administration | `8` | `0` | `147` | `0` | `11` | `5` | `0` | `0` | `6` | `22` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`853`** | **`737`** | **`0`** | **`0`** | **`116`** | **`505`** |
...
represented option pairs or `737/853` passing written rows as a Git support
percentage. The `737/853` number is audit progress for supported rows already
written down; `116/853` additional rows are stock-compatible invalid inputs. It
...
| `clean` | `13` | `0` | `3` | `docs/cli/matrices/clean_v2_47.tsv` | `9` | `5` | `0` | `0` | `4` | no |
