...
| Written behavior rows | `187` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Behavior rows matching stock Git | `172/187` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `309` | `127` | `116` | `0` | `9` | `2` | `16` |
...
| **Git 2.47 unique total** | **`151`** | **`4632`** | **`187`** | **`172`** | **`0`** | **`9`** | **`6`** | **`269`** |
...
Never use `151/151` command presence, `4632` option spellings or `172/187`
passing written rows as a Git support percentage. The `172/187` number is audit
...
| `fetch` | `73` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `127` | `116` | `0` | `9` | `2` | no |
