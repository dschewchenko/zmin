...
| Written behavior rows | `757` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `681/757` | yes, row by row | exact written rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `160` | `130` | `0` | `0` | `30` | `84` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`757`** | **`681`** | **`0`** | **`0`** | **`76`** | **`425`** |
...
represented option pairs or `681/757` passing written rows as a Git support
percentage. The `681/757` number is audit progress for rows already written
...
| `config` | `243` | `0` | `17` | `docs/cli/matrices/config_v2_47.tsv` | `52` | `43` | `0` | `0` | `9` | no |
...
| `log` | `282` | `0` | `32` | `docs/cli/matrices/log_v2_47.tsv` | `83` | `80` | `0` | `0` | `3` | no |
| `for-each-ref` | `22` | `0` | `2` | `docs/cli/matrices/for_each_ref_v2_47.tsv` | `34` | `23` | `0` | `0` | `11` | no |
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `54` | `46` | `0` | `0` | `8` | no |
