...
| Git doc option pairs represented by rows | `366/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1557` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1265/1557` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1557` | no | written rows with incomplete parity |
| Open written rows | `1/1557` | no | written rows that still do not match stock Git |
| Invalid input rows | `291/1557` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `220` | `213` | `0` | `0` | `7` | `26` |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `360` | `297` | `0` | `0` | `63` | `116` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `53` | `26` | `0` | `0` | `27` | `40` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1557`** | **`1265`** | **`0`** | **`1`** | **`291`** | **`721`** |
...
Never use `151/151` command presence, `4632` option spellings, `366/4632`
represented option pairs or `1265/1557` passing written rows as a Git support
percentage. The `1265/1557` number is audit progress for supported rows already
written down; `0/1557` rows are partial, `1/1557` rows are open and `291/1557`
...
| `diff` | `133` | `0` | `51` | `docs/cli/matrices/diff_v2_47.tsv` | `122` | `120` | `0` | `0` | `2` | no |
| `diff-files` | `130` | `0` | `3` | `docs/cli/matrices/diff_files_v2_47.tsv` | `5` | `5` | `0` | `0` | `0` | no |
| `diff-index` | `124` | `0` | `2` | `docs/cli/matrices/diff_index_v2_47.tsv` | `2` | `2` | `0` | `0` | `0` | no |
