...
| Written behavior rows | `1012` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `773/1012` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1012` | no | written rows with incomplete parity |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1012`** | **`773`** | **`1`** | **`0`** | **`238`** | **`650`** |
...
represented option pairs or `773/1012` passing written rows as a Git support
percentage. The `773/1012` number is audit progress for supported rows already
written down; `1/1012` row is partial and `238/1012` additional rows are
