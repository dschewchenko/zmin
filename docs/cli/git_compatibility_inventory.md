...
| Written behavior rows | `921` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/921` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `71` | `21` | `0` | `0` | `50` | `123` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`921`** | **`755`** | **`0`** | **`0`** | **`166`** | **`571`** |
...
represented option pairs or `755/921` passing written rows as a Git support
percentage. The `755/921` number is audit progress for supported rows already
written down; `166/921` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `70` | `21` | `0` | `0` | `49` | no |
