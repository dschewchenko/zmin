...
| Written behavior rows | `793` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `717/793` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`793`** | **`717`** | **`0`** | **`0`** | **`76`** | **`461`** |
...
represented option pairs or `717/793` passing written rows as a Git support
percentage. The `717/793` number is audit progress for rows already written
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `58` | `58` | `0` | `0` | `0` | no |
