...
| Written behavior rows | `794` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `718/794` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`794`** | **`718`** | **`0`** | **`0`** | **`76`** | **`462`** |
...
represented option pairs or `718/794` passing written rows as a Git support
percentage. The `718/794` number is audit progress for rows already written
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `59` | `59` | `0` | `0` | `0` | no |
