...
| Written behavior rows | `838` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `732/838` | yes, row by row | supported-behavior rows with parity evidence |
...
| Administration | `8` | `0` | `147` | `0` | `3` | `0` | `0` | `0` | `3` | `19` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`838`** | **`732`** | **`0`** | **`0`** | **`106`** | **`502`** |
...
represented option pairs or `732/838` passing written rows as a Git support
percentage. The `732/838` number is audit progress for supported rows already
written down; `106/838` additional rows are stock-compatible invalid inputs. It
