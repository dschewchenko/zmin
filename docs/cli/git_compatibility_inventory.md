...
| Written behavior rows | `1047` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `787/1047` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1047` | no | written rows with incomplete parity |
| Open written rows | `0/1047` | no | written rows that still do not match stock Git |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `299` | `283` | `0` | `0` | `16` | `159` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1047`** | **`787`** | **`1`** | **`0`** | **`259`** | **`683`** |
...
represented option pairs or `787/1047` passing written rows as a Git support
percentage. The `787/1047` number is audit progress for supported rows already
written down; `1/1047` row is partial and `259/1047` additional rows are
