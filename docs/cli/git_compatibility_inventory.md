...
| Written behavior rows | `163` | no by itself | explicit rows currently written |
| Closed behavior rows | `148/163` | yes, row by row | exact written rows that match stock Git |
...
| Sharing and Updating Projects | `5` | `309` | `103` | `92` | `0` | `9` | `2` | `0` |
...
| **Git 2.47 unique total** | **`151`** | **`4632`** | **`163`** | **`148`** | **`0`** | **`9`** | **`6`** | **`253`** |
...
Never use `151/151` command presence, `4632` option spellings or `148/163`
closed written rows as a Git support percentage. The `148/163` number is audit
...
| `fetch` | `73` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `103` | `92` | `0` | `9` | `2` | no |
...
local/file explicit-branch `--shallow-since` forms in existing shallow repos.
...
override plus shallow-exclude combinations remain open.
