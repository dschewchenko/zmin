...
| Written behavior rows | `904` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `744/904` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `54` | `10` | `0` | `0` | `44` | `106` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`904`** | **`744`** | **`0`** | **`0`** | **`160`** | **`554`** |
...
represented option pairs or `744/904` passing written rows as a Git support
percentage. The `744/904` number is audit progress for supported rows already
written down; `160/904` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `53` | `10` | `0` | `0` | `43` | no |
