...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `167` | `150` | `0` | `0` | `17` | `24` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2846`** | **`2457`** | **`0`** | **`1`** | **`388`** | **`1018`** |
...
represented option pairs or `2457/2846` passing written rows as a Git support
percentage. The `2457/2846` number is audit progress for supported rows already
written down; `0/2846` rows are partial, `1/2846` rows are open and `388/2846`
...
| `credential` | `0` | `0` | `0` | `docs/cli/matrices/credential_v2_47.tsv` | `5` | `4` | `0` | `0` | `1` | no |
