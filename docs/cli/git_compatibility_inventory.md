...
| Written behavior rows | `2845` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2456/2845` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2845` | no | written rows with incomplete parity |
| Open written rows | `1/2845` | no | written rows that still do not match stock Git |
| Invalid input rows | `388/2845` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `582` | `514` | `0` | `0` | `68` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `174` | `137` | `0` | `0` | `37` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2845`** | **`2456`** | **`0`** | **`1`** | **`388`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `729/4632`
represented option pairs or `2456/2845` passing written rows as a Git support
percentage. The `2456/2845` number is audit progress for supported rows already
written down; `0/2845` rows are partial, `1/2845` rows are open and `388/2845`
...
| `update-ref` | `6` | `0` | `5` | `docs/cli/matrices/update_ref_v2_47.tsv` | `9` | `9` | `0` | `0` | `0` | no |
