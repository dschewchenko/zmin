...
- `docs/cli/matrices/diff_v2_47.tsv` tracks the first `diff` output format,
  patch, reverse, pickaxe, ordering, path, exit-code, word-diff, algorithm and
  binary-text variants.
- `docs/cli/matrices/diff_files_v2_47.tsv` tracks the first `diff-files`
  word-diff and algorithm variants.
...
| Git doc option pairs represented by rows | `362/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1553` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1261/1553` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1553` | no | written rows with incomplete parity |
| Open written rows | `1/1553` | no | written rows that still do not match stock Git |
| Invalid input rows | `291/1553` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `218` | `211` | `0` | `0` | `7` | `26` |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `359` | `296` | `0` | `0` | `63` | `116` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `52` | `25` | `0` | `0` | `27` | `40` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1553`** | **`1261`** | **`0`** | **`1`** | **`291`** | **`721`** |
...
Never use `151/151` command presence, `4632` option spellings, `362/4632`
represented option pairs or `1261/1553` passing written rows as a Git support
percentage. The `1261/1553` number is audit progress for supported rows already
written down; `0/1553` rows are partial, `1/1553` rows are open and `291/1553`
...
| `diff` | `133` | `0` | `49` | `docs/cli/matrices/diff_v2_47.tsv` | `120` | `118` | `0` | `0` | `2` | no |
| `diff-files` | `130` | `0` | `2` | `docs/cli/matrices/diff_files_v2_47.tsv` | `4` | `4` | `0` | `0` | `0` | no |
| `diff-index` | `124` | `0` | `1` | `docs/cli/matrices/diff_index_v2_47.tsv` | `1` | `1` | `0` | `0` | `0` | no |
