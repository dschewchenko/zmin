...
| Written behavior rows | `121` | `106` | yes, for those rows only |
...
| Sharing and Updating Projects | `5` | `119` | `61` | `50` | `0` | `9` | `2` | `0` |
...
| **Git 2.47 unique total** | **`151`** | **`2500`** | **`121`** | **`106`** | **`0`** | **`9`** | **`6`** | **`253`** |
...
| `fetch` | `13` | `docs/cli/matrices/fetch_v2_47.tsv` | `61` | `50` | `0` | `9` | `2` |
