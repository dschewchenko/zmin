...
| Written behavior rows | `883` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/883` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `33` | `8` | `0` | `0` | `25` | `85` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`883`** | **`742`** | **`0`** | **`0`** | **`141`** | **`533`** |
...
represented option pairs or `742/883` passing written rows as a Git support
percentage. The `742/883` number is audit progress for supported rows already
written down; `141/883` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `32` | `8` | `0` | `0` | `24` | no |
