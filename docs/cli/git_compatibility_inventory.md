...
| Written behavior rows | `791` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `715/791` | yes, row by row | exact written rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `68` | `64` | `0` | `0` | `4` | `75` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `172` | `142` | `0` | `0` | `30` | `96` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`791`** | **`715`** | **`0`** | **`0`** | **`76`** | **`459`** |
...
represented option pairs or `715/791` passing written rows as a Git support
percentage. The `715/791` number is audit progress for rows already written
...
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `58` | `50` | `0` | `0` | `8` | no |
