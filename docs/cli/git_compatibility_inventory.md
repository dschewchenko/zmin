...
| Written rows matching stock Git | `794/1055` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1055` | no | written rows with incomplete parity |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1055`** | **`794`** | **`0`** | **`0`** | **`261`** | **`683`** |
...
represented option pairs or `794/1055` passing written rows as a Git support
percentage. The `794/1055` number is audit progress for supported rows already
written down; `0/1055` rows are partial and `261/1055` additional rows are
