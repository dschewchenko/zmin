...
| Written behavior rows | `665` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `590/665` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `205` | `198` | `0` | `4` | `3` | `92` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`665`** | **`590`** | **`0`** | **`4`** | **`71`** | **`358`** |
...
represented option pairs or `590/665` passing written rows as a Git support
percentage. The `590/665` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `205` | `198` | `0` | `4` | `3` | no |
