...
| Written behavior rows | `829` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `729/829` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `5` | `2` | `0` | `0` | `3` | `57` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`829`** | **`729`** | **`0`** | **`0`** | **`100`** | **`493`** |
...
represented option pairs or `729/829` passing written rows as a Git support
percentage. The `729/829` number is audit progress for supported rows already
written down; `100/829` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `2` | `docs/cli/matrices/blame_v2_47.tsv` | `4` | `2` | `0` | `0` | `2` | no |
