...
| Written behavior rows | `2794` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2406/2794` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2794` | no | written rows with incomplete parity |
| Open written rows | `1/2794` | no | written rows that still do not match stock Git |
| Invalid input rows | `387/2794` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `552` | `485` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `174` | `137` | `0` | `0` | `37` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2794`** | **`2406`** | **`0`** | **`1`** | **`387`** | **`1018`** |
...
represented option pairs or `2406/2794` passing written rows as a Git support
percentage. The `2406/2794` number is audit progress for supported rows already
written down; `0/2794` rows are partial, `1/2794` rows are open and `387/2794`
