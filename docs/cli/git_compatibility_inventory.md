...
| Written behavior rows | `2189` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1873/2189` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2189` | no | written rows with incomplete parity |
| Open written rows | `1/2189` | no | written rows that still do not match stock Git |
| Invalid input rows | `315/2189` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `132` | `100` | `0` | `0` | `32` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2189`** | **`1873`** | **`0`** | **`1`** | **`315`** | **`1018`** |
...
represented option pairs or `1873/2189` passing written rows as a Git support
percentage. The `1873/2189` number is audit progress for supported rows already
written down; `0/2189` rows are partial, `1/2189` rows are open and `315/2189`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `71` | `65` | `0` | `0` | `6` | no |
