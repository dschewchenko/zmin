...
| Written behavior rows | `630` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `554/630` | yes, row by row | exact written rows with parity evidence |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `120` | `119` | `0` | `0` | `1` | `19` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`630`** | **`554`** | **`0`** | **`8`** | **`68`** | **`347`** |
...
represented option pairs or `554/630` passing written rows as a Git support
percentage. The `554/630` number is audit progress for rows already written
...
| `log` | `282` | `0` | `32` | `docs/cli/matrices/log_v2_47.tsv` | `67` | `66` | `0` | `0` | `1` | no |
