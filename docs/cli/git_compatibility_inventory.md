...
| Written behavior rows | `826` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `727/826` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `2` | `0` | `0` | `0` | `2` | `54` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`826`** | **`727`** | **`0`** | **`0`** | **`99`** | **`490`** |
...
represented option pairs or `727/826` passing written rows as a Git support
percentage. The `727/826` number is audit progress for supported rows already
written down; `99/826` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `1` | `docs/cli/matrices/blame_v2_47.tsv` | `1` | `0` | `0` | `0` | `1` | no |
