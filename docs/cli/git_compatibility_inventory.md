...
| Written behavior rows | `2218` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1902/2218` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2218` | no | written rows with incomplete parity |
| Open written rows | `1/2218` | no | written rows that still do not match stock Git |
| Invalid input rows | `315/2218` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `161` | `129` | `0` | `0` | `32` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2218`** | **`1902`** | **`0`** | **`1`** | **`315`** | **`1018`** |
...
represented option pairs or `1902/2218` passing written rows as a Git support
percentage. The `1902/2218` number is audit progress for supported rows already
written down; `0/2218` rows are partial, `1/2218` rows are open and `315/2218`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `100` | `94` | `0` | `0` | `6` | no |
