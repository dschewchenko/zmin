...
| Written behavior rows | `210` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `195/210` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `309` | `150` | `139` | `0` | `9` | `2` | `39` |
...
| **Git 2.47 unique total** | **`151`** | **`4632`** | **`210`** | **`195`** | **`0`** | **`9`** | **`6`** | **`292`** |
...
Never use `151/151` command presence, `4632` option spellings or `195/210`
passing written rows as a Git support percentage. The `195/210` number is audit
...
| `fetch` | `73` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `150` | `139` | `0` | `9` | `2` | no |
...
branch fetches and explicit local/file HEAD fetches.
