...
| Written behavior rows | `1082` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `817/1082` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1082` | no | written rows with incomplete parity |
| Open written rows | `1/1082` | no | written rows that still do not match stock Git |
| Invalid input rows | `264/1082` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `306` | `289` | `0` | `0` | `17` | `159` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1082`** | **`817`** | **`0`** | **`1`** | **`264`** | **`683`** |
...
represented option pairs or `817/1082` passing written rows as a Git support
percentage. The `817/1082` number is audit progress for supported rows already
written down; `0/1082` rows are partial, `1/1082` rows are open and `264/1082`
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `297` | `289` | `0` | `0` | `8` | no |
