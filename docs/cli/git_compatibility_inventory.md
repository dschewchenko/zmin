...
| Written behavior rows | `722` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `646/722` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `256` | `250` | `0` | `0` | `6` | `141` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`722`** | **`646`** | **`0`** | **`0`** | **`76`** | **`413`** |
...
represented option pairs or `646/722` passing written rows as a Git support
percentage. The `646/722` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `256` | `250` | `0` | `0` | `6` | no |
