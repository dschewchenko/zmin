...
| Written behavior rows | `961` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `760/961` | yes, row by row | supported-behavior rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `191` | `149` | `0` | `0` | `42` | `107` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `6` | `2` | `0` | `0` | `4` | `5` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`961`** | **`760`** | **`0`** | **`0`** | **`201`** | **`610`** |
...
represented option pairs or `760/961` passing written rows as a Git support
percentage. The `760/961` number is audit progress for supported rows already
written down; `201/961` additional rows are stock-compatible invalid inputs. It
