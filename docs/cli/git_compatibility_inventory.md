...
| Written behavior rows | `881` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/881` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `31` | `8` | `0` | `0` | `23` | `83` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`881`** | **`742`** | **`0`** | **`0`** | **`139`** | **`531`** |
...
represented option pairs or `742/881` passing written rows as a Git support
percentage. The `742/881` number is audit progress for supported rows already
written down; `139/881` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `30` | `8` | `0` | `0` | `22` | no |
