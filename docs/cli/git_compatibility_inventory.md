...
| Written behavior rows | `709` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `634/709` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `249` | `242` | `0` | `1` | `6` | `133` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`709`** | **`634`** | **`0`** | **`1`** | **`74`** | **`399`** |
...
represented option pairs or `634/709` passing written rows as a Git support
percentage. The `634/709` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `249` | `242` | `0` | `1` | `6` | no |
