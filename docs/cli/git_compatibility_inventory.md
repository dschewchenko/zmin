...
| Written behavior rows | `725` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `649/725` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `259` | `253` | `0` | `0` | `6` | `144` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`725`** | **`649`** | **`0`** | **`0`** | **`76`** | **`416`** |
...
represented option pairs or `649/725` passing written rows as a Git support
percentage. The `649/725` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `259` | `253` | `0` | `0` | `6` | no |
