...
| Written behavior rows | `888` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/888` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `38` | `8` | `0` | `0` | `30` | `90` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`888`** | **`742`** | **`0`** | **`0`** | **`146`** | **`538`** |
...
represented option pairs or `742/888` passing written rows as a Git support
percentage. The `742/888` number is audit progress for supported rows already
written down; `146/888` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `37` | `8` | `0` | `0` | `29` | no |
