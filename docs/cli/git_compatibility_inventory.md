...
| Written behavior rows | `800` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `724/800` | yes, row by row | exact written rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `68` | `64` | `0` | `0` | `4` | `83` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`800`** | **`724`** | **`0`** | **`0`** | **`76`** | **`468`** |
...
represented option pairs or `724/800` passing written rows as a Git support
percentage. The `724/800` number is audit progress for rows already written
