...
| Written behavior rows | `870` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/870` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `20` | `8` | `0` | `0` | `12` | `72` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`870`** | **`742`** | **`0`** | **`0`** | **`128`** | **`520`** |
...
represented option pairs or `742/870` passing written rows as a Git support
percentage. The `742/870` number is audit progress for supported rows already
written down; `128/870` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `19` | `8` | `0` | `0` | `11` | no |
