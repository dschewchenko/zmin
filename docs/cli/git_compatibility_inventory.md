...
| Written behavior rows | `796` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `720/796` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`796`** | **`720`** | **`0`** | **`0`** | **`76`** | **`464`** |
...
represented option pairs or `720/796` passing written rows as a Git support
percentage. The `720/796` number is audit progress for rows already written
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `61` | `61` | `0` | `0` | `0` | no |
