...
| Written behavior rows | `797` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `721/797` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`797`** | **`721`** | **`0`** | **`0`** | **`76`** | **`465`** |
...
represented option pairs or `721/797` passing written rows as a Git support
percentage. The `721/797` number is audit progress for rows already written
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `62` | `62` | `0` | `0` | `0` | no |
