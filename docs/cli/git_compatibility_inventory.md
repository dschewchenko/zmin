...
| Written behavior rows | `1192` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `910/1192` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1192` | no | written rows with incomplete parity |
| Open written rows | `1/1192` | no | written rows that still do not match stock Git |
| Invalid input rows | `281/1192` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `232` | `170` | `0` | `0` | `62` | `116` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `48` | `21` | `0` | `0` | `27` | `40` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1192`** | **`910`** | **`0`** | **`1`** | **`281`** | **`721`** |
...
represented option pairs or `910/1192` passing written rows as a Git support
percentage. The `910/1192` number is audit progress for supported rows already
written down; `0/1192` rows are partial, `1/1192` rows are open and `281/1192`
...
| `ls-files` | `42` | `0` | `28` | `docs/cli/matrices/ls_files_v2_47.tsv` | `77` | `60` | `0` | `0` | `17` | no |
