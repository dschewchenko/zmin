...
| Written behavior rows | `2199` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1883/2199` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2199` | no | written rows with incomplete parity |
| Open written rows | `1/2199` | no | written rows that still do not match stock Git |
| Invalid input rows | `315/2199` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `142` | `110` | `0` | `0` | `32` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2199`** | **`1883`** | **`0`** | **`1`** | **`315`** | **`1018`** |
...
represented option pairs or `1883/2199` passing written rows as a Git support
percentage. The `1883/2199` number is audit progress for supported rows already
written down; `0/2199` rows are partial, `1/2199` rows are open and `315/2199`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `81` | `75` | `0` | `0` | `6` | no |
