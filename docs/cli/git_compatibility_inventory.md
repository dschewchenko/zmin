...
| Written behavior rows | `869` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/869` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `19` | `8` | `0` | `0` | `11` | `71` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`869`** | **`742`** | **`0`** | **`0`** | **`127`** | **`519`** |
...
represented option pairs or `742/869` passing written rows as a Git support
percentage. The `742/869` number is audit progress for supported rows already
written down; `127/869` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `18` | `8` | `0` | `0` | `10` | no |
