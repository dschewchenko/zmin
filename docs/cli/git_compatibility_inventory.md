...
| Git doc option pairs represented by rows | `534/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2085` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1774/2085` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2085` | no | written rows with incomplete parity |
| Open written rows | `1/2085` | no | written rows that still do not match stock Git |
| Invalid input rows | `310/2085` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Debugging | `3` | `0` | `132` | `0` | `164` | `83` | `0` | `0` | `81` | `166` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2085`** | **`1774`** | **`0`** | **`1`** | **`310`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `534/4632`
represented option pairs or `1774/2085` passing written rows as a Git support
percentage. The `1774/2085` number is audit progress for supported rows already
written down; `0/2085` rows are partial, `1/2085` rows are open and `310/2085`
...
| `blame` | `39` | `0` | `24` | `docs/cli/matrices/blame_v2_47.tsv` | `151` | `71` | `0` | `0` | `80` | no |
