...
| Written behavior rows | `147` | no by itself | explicit rows currently written |
| Closed behavior rows | `132/147` | yes, row by row | exact written rows that match stock Git |
...
| Sharing and Updating Projects | `5` | `309` | `87` | `76` | `0` | `9` | `2` | `0` |
...
| **Git 2.47 unique total** | **`151`** | **`4632`** | **`147`** | **`132`** | **`0`** | **`9`** | **`6`** | **`253`** |
...
Never use `151/151` command presence, `4632` option spellings or `132/147`
closed written rows as a Git support percentage. The `132/147` number is audit
...
| `fetch` | `73` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `87` | `76` | `0` | `9` | `2` | no |
...
and local/file explicit-branch `--deepen=1` in existing shallow repos.
...
override plus unshallow, shallow-since and shallow-exclude combinations remain
open.
