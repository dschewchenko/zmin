...
| Git doc option pairs represented by rows | `545/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2137` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1826/2137` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2137` | no | written rows with incomplete parity |
| Open written rows | `1/2137` | no | written rows that still do not match stock Git |
| Invalid input rows | `310/2137` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `499` | `432` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `125` | `91` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2137`** | **`1826`** | **`0`** | **`1`** | **`310`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `545/4632`
represented option pairs or `1826/2137` passing written rows as a Git support
percentage. The `1826/2137` number is audit progress for supported rows already
written down; `0/2137` rows are partial, `1/2137` rows are open and `310/2137`
...
| `diff-files` | `130` | `0` | `10` | `docs/cli/matrices/diff_files_v2_47.tsv` | `17` | `17` | `0` | `0` | `0` | no |
| `diff-index` | `124` | `0` | `8` | `docs/cli/matrices/diff_index_v2_47.tsv` | `12` | `12` | `0` | `0` | `0` | no |
