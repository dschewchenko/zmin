...
| Written behavior rows | `807` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `727/807` | yes, row by row | supported-behavior rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `174` | `144` | `0` | `0` | `30` | `98` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `5` | `2` | `0` | `0` | `3` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`807`** | **`727`** | **`0`** | **`0`** | **`80`** | **`471`** |
...
represented option pairs or `727/807` passing written rows as a Git support
percentage. The `727/807` number is audit progress for supported rows already
written down; `80/807` additional rows are stock-compatible invalid inputs. It
...
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `47` | `43` | `0` | `0` | `4` | no |
