...
| Written behavior rows | `1432` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1148/1432` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1432` | no | written rows with incomplete parity |
| Open written rows | `1/1432` | no | written rows that still do not match stock Git |
| Invalid input rows | `283/1432` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `105` | `94` | `0` | `0` | `11` | `8` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1432`** | **`1148`** | **`0`** | **`1`** | **`283`** | **`721`** |
...
represented option pairs or `1148/1432` passing written rows as a Git support
percentage. The `1148/1432` number is audit progress for supported rows already
written down; `0/1432` rows are partial, `1/1432` rows are open and `283/1432`
...
| `var` | `3` | `0` | `1` | `docs/cli/matrices/var_v2_47.tsv` | `10` | `9` | `0` | `0` | `1` | no |
