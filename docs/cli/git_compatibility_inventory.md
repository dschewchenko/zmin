...
| Written behavior rows | `1793` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1490/1793` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1793` | no | written rows with incomplete parity |
| Open written rows | `1/1793` | no | written rows that still do not match stock Git |
| Invalid input rows | `302/1793` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `408` | `343` | `0` | `0` | `65` | `171` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `106` | `72` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1793`** | **`1490`** | **`0`** | **`1`** | **`302`** | **`933`** |
...
represented option pairs or `1490/1793` passing written rows as a Git support
percentage. The `1490/1793` number is audit progress for supported rows already
written down; `0/1793` rows are partial, `1/1793` rows are open and `302/1793`
...
| `ls-files` | `42` | `0` | `29` | `docs/cli/matrices/ls_files_v2_47.tsv` | `152` | `132` | `0` | `0` | `20` | no |
