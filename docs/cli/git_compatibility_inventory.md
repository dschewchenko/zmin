...
| Written behavior rows | `1084` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `818/1084` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1084` | no | written rows with incomplete parity |
| Open written rows | `1/1084` | no | written rows that still do not match stock Git |
| Invalid input rows | `265/1084` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `308` | `290` | `0` | `0` | `18` | `159` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1084`** | **`818`** | **`0`** | **`1`** | **`265`** | **`683`** |
...
represented option pairs or `818/1084` passing written rows as a Git support
percentage. The `818/1084` number is audit progress for supported rows already
written down; `0/1084` rows are partial, `1/1084` rows are open and `265/1084`
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `299` | `290` | `0` | `0` | `9` | no |
