...
| Written behavior rows | `891` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/891` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `41` | `8` | `0` | `0` | `33` | `93` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`891`** | **`742`** | **`0`** | **`0`** | **`149`** | **`541`** |
...
represented option pairs or `742/891` passing written rows as a Git support
percentage. The `742/891` number is audit progress for supported rows already
written down; `149/891` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `40` | `8` | `0` | `0` | `32` | no |
