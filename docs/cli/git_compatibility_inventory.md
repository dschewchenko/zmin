...
| Written behavior rows | `183` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Behavior rows matching stock Git | `168/183` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `309` | `123` | `112` | `0` | `9` | `2` | `12` |
...
| **Git 2.47 unique total** | **`151`** | **`4632`** | **`183`** | **`168`** | **`0`** | **`9`** | **`6`** | **`265`** |
...
Never use `151/151` command presence, `4632` option spellings or `168/183`
passing written rows as a Git support percentage. The `168/183` number is audit
...
| `fetch` | `73` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `123` | `112` | `0` | `9` | `2` | no |
