...
| Written behavior rows | `926` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/926` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `76` | `21` | `0` | `0` | `55` | `128` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`926`** | **`755`** | **`0`** | **`0`** | **`171`** | **`576`** |
...
represented option pairs or `755/926` passing written rows as a Git support
percentage. The `755/926` number is audit progress for supported rows already
written down; `171/926` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `75` | `21` | `0` | `0` | `54` | no |
