...
| Git doc option pairs represented by rows | `524/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2055` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1744/2055` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2055` | no | written rows with incomplete parity |
| Open written rows | `1/2055` | no | written rows that still do not match stock Git |
| Invalid input rows | `310/2055` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `373` | `365` | `0` | `0` | `8` | `52` |
| Patching | `5` | `0` | `333` | `0` | `21` | `19` | `0` | `0` | `2` | `11` |
| Debugging | `3` | `0` | `132` | `0` | `134` | `53` | `0` | `0` | `81` | `166` |
...
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `114` | `80` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2055`** | **`1744`** | **`0`** | **`1`** | **`310`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `524/4632`
represented option pairs or `1744/2055` passing written rows as a Git support
percentage. The `1744/2055` number is audit progress for supported rows already
written down; `0/2055` rows are partial, `1/2055` rows are open and `310/2055`
...
| `blame` | `39` | `0` | `14` | `docs/cli/matrices/blame_v2_47.tsv` | `121` | `41` | `0` | `0` | `80` | no |
