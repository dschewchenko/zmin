...
| Written behavior rows | `874` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/874` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `24` | `8` | `0` | `0` | `16` | `76` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`874`** | **`742`** | **`0`** | **`0`** | **`132`** | **`524`** |
...
represented option pairs or `742/874` passing written rows as a Git support
percentage. The `742/874` number is audit progress for supported rows already
written down; `132/874` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `23` | `8` | `0` | `0` | `15` | no |
