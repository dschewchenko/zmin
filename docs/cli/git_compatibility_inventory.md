...
- `docs/cli/matrices/maintenance_v2_47.tsv` tracks the first `maintenance run`
  invalid-input schedule and task variants.
...
| Commands with any matrix rows | `40/151` | no | audit rows exist for `archive`, `bisect`, `blame`, `branch`, `bundle`, `cat-file`, `clean`, `column`, `commit-graph`, `config`, `diff`, `fast-import`, `fetch`, `for-each-ref`, `index-pack`, `log`, `ls-files`, `ls-tree`, `maintenance`, `merge`, `merge-base`, `multi-pack-index`, `notes`, `pack-objects`, `prune`, `rebase`, `reflog`, `rerere`, `rev-parse`, `show-index`, `show-ref`, `sparse-checkout`, `stash`, `status`, `submodule`, `symbolic-ref`, `tag`, `verify-pack`, `version` and `worktree` |
| Git doc option pairs represented by rows | `244/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1036` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `784/1036` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1036` | no | written rows with incomplete parity |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `81` | `66` | `0` | `0` | `15` | `99` |
| Branching and Merging | `9` | `0` | `581` | `0` | `65` | `39` | `0` | `0` | `26` | `32` |
...
| Administration | `8` | `0` | `147` | `0` | `33` | `11` | `0` | `0` | `22` | `34` |
| Server Admin | `2` | `0` | `30` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| Plumbing Commands | `20` | `0` | `644` | `0` | `201` | `151` | `0` | `0` | `50` | `116` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `43` | `16` | `1` | `0` | `26` | `39` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1036`** | **`784`** | **`1`** | **`0`** | **`251`** | **`670`** |
...
Never use `151/151` command presence, `4632` option spellings, `244/4632`
represented option pairs or `784/1036` passing written rows as a Git support
percentage. The `784/1036` number is audit progress for supported rows already
written down; `1/1036` row is partial and `251/1036` additional rows are
...
| `maintenance` | `14` | `0` | `2` | `docs/cli/matrices/maintenance_v2_47.tsv` | `4` | `0` | `0` | `0` | `4` | no |
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `5` | `4` | `0` | `0` | `1` | no |
