...
| Written behavior rows | `197` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `182/197` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `309` | `137` | `126` | `0` | `9` | `2` | `26` |
...
| **Git 2.47 unique total** | **`151`** | **`4632`** | **`197`** | **`182`** | **`0`** | **`9`** | **`6`** | **`279`** |
...
Never use `151/151` command presence, `4632` option spellings or `182/197`
passing written rows as a Git support percentage. The `182/197` number is audit
...
| `fetch` | `73` | `28` | `docs/cli/matrices/fetch_v2_47.tsv` | `137` | `126` | `0` | `9` | `2` | no |
