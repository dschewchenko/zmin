...
| Written behavior rows | `764` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `688/764` | yes, row by row | exact written rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `163` | `133` | `0` | `0` | `30` | `87` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`764`** | **`688`** | **`0`** | **`0`** | **`76`** | **`432`** |
...
represented option pairs or `688/764` passing written rows as a Git support
percentage. The `688/764` number is audit progress for rows already written
...
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `40` | `36` | `0` | `0` | `4` | no |
