...
| Git doc option pairs represented by rows | `675/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2766` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2378/2766` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2766` | no | written rows with incomplete parity |
| Open written rows | `1/2766` | no | written rows that still do not match stock Git |
| Invalid input rows | `387/2766` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `299` | `266` | `0` | `0` | `33` | `145` |
...
| Administration | `8` | `0` | `147` | `0` | `153` | `92` | `0` | `0` | `61` | `58` |
| Server Admin | `2` | `0` | `30` | `0` | `2` | `2` | `0` | `0` | `0` | `0` |
| Plumbing Commands | `21` | `0` | `650` | `0` | `547` | `480` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `174` | `137` | `0` | `0` | `37` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2766`** | **`2378`** | **`0`** | **`1`** | **`387`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `675/4632`
represented option pairs or `2378/2766` passing written rows as a Git support
percentage. The `2378/2766` number is audit progress for supported rows already
written down; `0/2766` rows are partial, `1/2766` rows are open and `387/2766`
...
| --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `add` | `34` | `0` | `11` | `docs/cli/matrices/add_v2_47.tsv` | `44` | `32` | `0` | `0` | `12` | no |
...
| `commit` | `63` | `0` | `26` | `docs/cli/matrices/commit_v2_47.tsv` | `68` | `65` | `0` | `0` | `3` | no |
