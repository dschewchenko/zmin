...
| Git doc option pairs represented by rows | `606/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2638` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2261/2638` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2638` | no | written rows with incomplete parity |
| Open written rows | `1/2638` | no | written rows that still do not match stock Git |
| Invalid input rows | `376/2638` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `405` | `380` | `0` | `0` | `25` | `160` |
...
| Administration | `8` | `0` | `147` | `0` | `139` | `78` | `0` | `0` | `61` | `58` |
| Server Admin | `2` | `0` | `30` | `0` | `2` | `2` | `0` | `0` | `0` | `0` |
| Plumbing Commands | `21` | `0` | `650` | `0` | `509` | `442` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `156` | `120` | `0` | `0` | `36` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2638`** | **`2261`** | **`0`** | **`1`** | **`376`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `606/4632`
represented option pairs or `2261/2638` passing written rows as a Git support
percentage. The `2261/2638` number is audit progress for supported rows already
written down; `0/2638` rows are partial, `1/2638` rows are open and `376/2638`
...
| `maintenance` | `14` | `0` | `4` | `docs/cli/matrices/maintenance_v2_47.tsv` | `19` | `13` | `0` | `0` | `6` | no |
