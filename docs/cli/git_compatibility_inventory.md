...
| Written behavior rows | `2344` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2012/2344` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2344` | no | written rows with incomplete parity |
| Open written rows | `1/2344` | no | written rows that still do not match stock Git |
| Invalid input rows | `331/2344` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Administration | `8` | `0` | `147` | `0` | `95` | `65` | `0` | `0` | `30` | `58` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2344`** | **`2012`** | **`0`** | **`1`** | **`331`** | **`1018`** |
...
represented option pairs or `2012/2344` passing written rows as a Git support
percentage. The `2012/2344` number is audit progress for supported rows already
written down; `0/2344` rows are partial, `1/2344` rows are open and `331/2344`
...
| `fsck` | `17` | `0` | `0` | `docs/cli/matrices/fsck_v2_47.tsv` | `5` | `0` | `0` | `0` | `5` | no |
