...
| Written behavior rows | `885` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/885` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `35` | `8` | `0` | `0` | `27` | `87` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`885`** | **`742`** | **`0`** | **`0`** | **`143`** | **`535`** |
...
represented option pairs or `742/885` passing written rows as a Git support
percentage. The `742/885` number is audit progress for supported rows already
written down; `143/885` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `34` | `8` | `0` | `0` | `26` | no |
