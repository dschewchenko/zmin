...
| Written behavior rows | `1002` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `770/1002` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1002` | no | written rows with incomplete parity |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `28` | `7` | `1` | `0` | `20` | `27` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1002`** | **`770`** | **`1`** | **`0`** | **`231`** | **`647`** |
...
represented option pairs or `770/1002` passing written rows as a Git support
percentage. The `770/1002` number is audit progress for supported rows already
written down; `1/1002` row is partial and `231/1002` additional rows are
