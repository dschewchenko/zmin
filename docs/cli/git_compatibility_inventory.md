...
| Written behavior rows | `868` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/868` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `18` | `8` | `0` | `0` | `10` | `70` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`868`** | **`742`** | **`0`** | **`0`** | **`126`** | **`518`** |
...
represented option pairs or `742/868` passing written rows as a Git support
percentage. The `742/868` number is audit progress for supported rows already
written down; `126/868` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `17` | `8` | `0` | `0` | `9` | no |
