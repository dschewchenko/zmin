...
| Written behavior rows | `1273` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `990/1273` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1273` | no | written rows with incomplete parity |
| Open written rows | `1/1273` | no | written rows that still do not match stock Git |
| Invalid input rows | `282/1273` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `168` | `161` | `0` | `0` | `7` | `26` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1273`** | **`990`** | **`0`** | **`1`** | **`282`** | **`721`** |
...
represented option pairs or `990/1273` passing written rows as a Git support
percentage. The `990/1273` number is audit progress for supported rows already
written down; `0/1273` rows are partial, `1/1273` rows are open and `282/1273`
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `81` | `79` | `0` | `0` | `2` | no |
