...
| Written behavior rows | `798` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `722/798` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`798`** | **`722`** | **`0`** | **`0`** | **`76`** | **`466`** |
...
represented option pairs or `722/798` passing written rows as a Git support
percentage. The `722/798` number is audit progress for rows already written
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `63` | `63` | `0` | `0` | `0` | no |
