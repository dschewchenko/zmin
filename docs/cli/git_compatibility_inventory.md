...
| Written behavior rows | `770` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `694/770` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `286` | `280` | `0` | `0` | `6` | `148` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`770`** | **`694`** | **`0`** | **`0`** | **`76`** | **`438`** |
...
represented option pairs or `694/770` passing written rows as a Git support
percentage. The `694/770` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `286` | `280` | `0` | `0` | `6` | no |
