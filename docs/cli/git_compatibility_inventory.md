...
| Written behavior rows | `1052` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `790/1052` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1052` | no | written rows with incomplete parity |
| Open written rows | `0/1052` | no | written rows that still do not match stock Git |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `45` | `17` | `1` | `0` | `27` | `39` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1052`** | **`790`** | **`1`** | **`0`** | **`261`** | **`683`** |
...
represented option pairs or `790/1052` passing written rows as a Git support
percentage. The `790/1052` number is audit progress for supported rows already
written down; `1/1052` row is partial and `261/1052` additional rows are
