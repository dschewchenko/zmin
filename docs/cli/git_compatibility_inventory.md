...
| Written behavior rows | `1087` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `819/1087` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1087` | no | written rows with incomplete parity |
| Open written rows | `1/1087` | no | written rows that still do not match stock Git |
| Invalid input rows | `267/1087` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `309` | `291` | `0` | `0` | `18` | `159` |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `48` | `21` | `0` | `0` | `27` | `40` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1087`** | **`819`** | **`0`** | **`1`** | **`267`** | **`684`** |
...
represented option pairs or `819/1087` passing written rows as a Git support
percentage. The `819/1087` number is audit progress for supported rows already
written down; `0/1087` rows are partial, `1/1087` rows are open and `267/1087`
