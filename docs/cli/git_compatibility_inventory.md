...
| Written behavior rows | `730` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `654/730` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `264` | `258` | `0` | `0` | `6` | `147` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`730`** | **`654`** | **`0`** | **`0`** | **`76`** | **`419`** |
...
represented option pairs or `654/730` passing written rows as a Git support
percentage. The `654/730` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `264` | `258` | `0` | `0` | `6` | no |
