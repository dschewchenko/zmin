...
| Written behavior rows | `865` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `739/865` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `15` | `5` | `0` | `0` | `10` | `67` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`865`** | **`739`** | **`0`** | **`0`** | **`126`** | **`515`** |
...
represented option pairs or `739/865` passing written rows as a Git support
percentage. The `739/865` number is audit progress for supported rows already
written down; `126/865` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `14` | `5` | `0` | `0` | `9` | no |
