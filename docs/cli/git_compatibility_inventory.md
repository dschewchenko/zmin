...
| Written behavior rows | `1167` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `885/1167` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1167` | no | written rows with incomplete parity |
| Open written rows | `1/1167` | no | written rows that still do not match stock Git |
| Invalid input rows | `281/1167` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `93` | `63` | `0` | `0` | `30` | `50` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1167`** | **`885`** | **`0`** | **`1`** | **`281`** | **`721`** |
...
represented option pairs or `885/1167` passing written rows as a Git support
percentage. The `885/1167` number is audit progress for supported rows already
written down; `0/1167` rows are partial, `1/1167` rows are open and `281/1167`
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `32` | `28` | `0` | `0` | `4` | no |
