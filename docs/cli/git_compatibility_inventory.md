...
| Git doc option pairs represented by rows | `700/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2795` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2407/2795` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2795` | no | written rows with incomplete parity |
| Open written rows | `1/2795` | no | written rows that still do not match stock Git |
| Invalid input rows | `387/2795` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `553` | `486` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `174` | `137` | `0` | `0` | `37` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2795`** | **`2407`** | **`0`** | **`1`** | **`387`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `700/4632`
represented option pairs or `2407/2795` passing written rows as a Git support
percentage. The `2407/2795` number is audit progress for supported rows already
written down; `0/2795` rows are partial, `1/2795` rows are open and `387/2795`
...
| `hash-object` | `7` | `0` | `2` | `docs/cli/matrices/hash_object_v2_47.tsv` | `5` | `5` | `0` | `0` | `0` | no |
...
| `read-tree` | `22` | `0` | `3` | `docs/cli/matrices/read_tree_v2_47.tsv` | `4` | `4` | `0` | `0` | `0` | no |
