...
| Git doc option pairs represented by rows | `589/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2547` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2173/2547` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2547` | no | written rows with incomplete parity |
| Open written rows | `1/2547` | no | written rows that still do not match stock Git |
| Invalid input rows | `373/2547` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Getting and Creating Projects | `2` | `0` | `66` | `0` | `63` | `56` | `0` | `1` | `6` | `47` |
| Basic Snapshotting | `9` | `0` | `371` | `0` | `292` | `261` | `0` | `0` | `31` | `145` |
| Branching and Merging | `9` | `0` | `581` | `0` | `268` | `225` | `0` | `0` | `43` | `50` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `373` | `348` | `0` | `0` | `25` | `160` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2547`** | **`2173`** | **`0`** | **`1`** | **`373`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `589/4632`
represented option pairs or `2173/2547` passing written rows as a Git support
percentage. The `2173/2547` number is audit progress for supported rows already
written down; `0/2547` rows are partial, `1/2547` rows are open and `373/2547`
...
| `clone` | `56` | `0` | `24` | `docs/cli/matrices/clone_v2_47.tsv` | `61` | `54` | `0` | `1` | `6` | no |
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `310` | `300` | `0` | `0` | `10` | no |
