...
| Git doc option pairs represented by rows | `233/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `845` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `732/845` | yes, row by row | supported-behavior rows with parity evidence |
...
| Administration | `8` | `0` | `147` | `0` | `6` | `0` | `0` | `0` | `6` | `22` |
| Server Admin | `2` | `0` | `30` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| Plumbing Commands | `20` | `0` | `644` | `0` | `181` | `144` | `0` | `0` | `37` | `101` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `6` | `2` | `0` | `0` | `4` | `5` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`845`** | **`732`** | **`0`** | **`0`** | **`113`** | **`505`** |
...
Never use `151/151` command presence, `4632` option spellings, `233/4632`
represented option pairs or `732/845` passing written rows as a Git support
percentage. The `732/845` number is audit progress for supported rows already
written down; `113/845` additional rows are stock-compatible invalid inputs. It
...
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `63` | `51` | `0` | `0` | `12` | no |
