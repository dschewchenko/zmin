...
| Written behavior rows | `1401` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1118/1401` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1401` | no | written rows with incomplete parity |
| Open written rows | `1/1401` | no | written rows that still do not match stock Git |
| Invalid input rows | `282/1401` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `74` | `64` | `0` | `0` | `10` | `8` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1401`** | **`1118`** | **`0`** | **`1`** | **`282`** | **`721`** |
...
represented option pairs or `1118/1401` passing written rows as a Git support
percentage. The `1118/1401` number is audit progress for supported rows already
written down; `0/1401` rows are partial, `1/1401` rows are open and `282/1401`
...
| `config` | `243` | `0` | `17` | `docs/cli/matrices/config_v2_47.tsv` | `74` | `64` | `0` | `0` | `10` | no |
