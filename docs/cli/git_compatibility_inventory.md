...
| Written behavior rows | `915` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `751/915` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `65` | `17` | `0` | `0` | `48` | `117` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`915`** | **`751`** | **`0`** | **`0`** | **`164`** | **`565`** |
...
represented option pairs or `751/915` passing written rows as a Git support
percentage. The `751/915` number is audit progress for supported rows already
written down; `164/915` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `64` | `17` | `0` | `0` | `47` | no |
