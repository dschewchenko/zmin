...
| Written behavior rows | `775` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `699/775` | yes, row by row | exact written rows with parity evidence |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `167` | `137` | `0` | `0` | `30` | `91` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`775`** | **`699`** | **`0`** | **`0`** | **`76`** | **`443`** |
...
represented option pairs or `699/775` passing written rows as a Git support
percentage. The `699/775` number is audit progress for rows already written
...
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `56` | `48` | `0` | `0` | `8` | no |
