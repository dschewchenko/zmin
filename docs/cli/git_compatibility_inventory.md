...
| Written behavior rows | `1459` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1169/1459` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1459` | no | written rows with incomplete parity |
| Open written rows | `1/1459` | no | written rows that still do not match stock Git |
| Invalid input rows | `289/1459` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `339` | `316` | `0` | `0` | `23` | `160` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1459`** | **`1169`** | **`0`** | **`1`** | **`289`** | **`721`** |
...
represented option pairs or `1169/1459` passing written rows as a Git support
percentage. The `1169/1459` number is audit progress for supported rows already
written down; `0/1459` rows are partial, `1/1459` rows are open and `289/1459`
...
| `remote` | `23` | `0` | `1` | `docs/cli/matrices/remote_v2_47.tsv` | `25` | `21` | `0` | `0` | `4` | no |
