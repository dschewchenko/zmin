...
| Written behavior rows | `940` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/940` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `90` | `21` | `0` | `0` | `69` | `142` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`940`** | **`755`** | **`0`** | **`0`** | **`185`** | **`590`** |
...
represented option pairs or `755/940` passing written rows as a Git support
percentage. The `755/940` number is audit progress for supported rows already
written down; `185/940` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `89` | `21` | `0` | `0` | `68` | no |
