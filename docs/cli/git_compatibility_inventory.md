...
| Written behavior rows | `705` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `625/705` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `245` | `233` | `0` | `7` | `5` | `130` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`705`** | **`625`** | **`0`** | **`7`** | **`73`** | **`396`** |
...
represented option pairs or `625/705` passing written rows as a Git support
percentage. The `625/705` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `245` | `233` | `0` | `7` | `5` | no |
