...
| Commands with any matrix rows | `26/151` | no | audit rows exist for `archive`, `bisect`, `blame`, `branch`, `cat-file`, `clean`, `column`, `config`, `status`, `fetch`, `diff`, `log`, `for-each-ref`, `ls-files`, `ls-tree`, `merge`, `merge-base`, `notes`, `reflog`, `rerere`, `rev-parse`, `show-ref`, `submodule`, `symbolic-ref`, `tag` and `version` |
| Git doc option pairs represented by rows | `236/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `943` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/943` | yes, row by row | supported-behavior rows with parity evidence |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `59` | `35` | `0` | `0` | `24` | `31` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `295` | `283` | `0` | `0` | `12` | `157` |
| Inspection and Comparison | `7` | `0` | `774` | `0` | `152` | `147` | `0` | `0` | `5` | `26` |
| Patching | `5` | `0` | `333` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| Debugging | `3` | `0` | `132` | `0` | `93` | `21` | `0` | `0` | `72` | `145` |
| Email | `6` | `0` | `361` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| External Systems | `2` | `0` | `120` | `0` | `0` | `0` | `0` | `0` | `0` | `0` |
| Administration | `8` | `0` | `147` | `0` | `13` | `7` | `0` | `0` | `6` | `22` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`943`** | **`755`** | **`0`** | **`0`** | **`188`** | **`593`** |
...
Never use `151/151` command presence, `4632` option spellings, `236/4632`
represented option pairs or `755/943` passing written rows as a Git support
percentage. The `755/943` number is audit progress for supported rows already
written down; `188/943` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `92` | `21` | `0` | `0` | `71` | no |
...
| `ls-files` | `42` | `0` | `27` | `docs/cli/matrices/ls_files_v2_47.tsv` | `66` | `51` | `0` | `0` | `15` | no |
