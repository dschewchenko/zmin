...
| Written behavior rows | `799` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `723/799` | yes, row by row | exact written rows with parity evidence |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`799`** | **`723`** | **`0`** | **`0`** | **`76`** | **`467`** |
...
represented option pairs or `723/799` passing written rows as a Git support
percentage. The `723/799` number is audit progress for rows already written
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `64` | `64` | `0` | `0` | `0` | no |
