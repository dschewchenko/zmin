...
| Written behavior rows | `934` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `755/934` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `84` | `21` | `0` | `0` | `63` | `136` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`934`** | **`755`** | **`0`** | **`0`** | **`179`** | **`584`** |
...
represented option pairs or `755/934` passing written rows as a Git support
percentage. The `755/934` number is audit progress for supported rows already
written down; `179/934` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `83` | `21` | `0` | `0` | `62` | no |
