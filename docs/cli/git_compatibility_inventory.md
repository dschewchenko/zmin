...
| Written behavior rows | `894` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/894` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `44` | `8` | `0` | `0` | `36` | `96` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`894`** | **`742`** | **`0`** | **`0`** | **`152`** | **`544`** |
...
represented option pairs or `742/894` passing written rows as a Git support
percentage. The `742/894` number is audit progress for supported rows already
written down; `152/894` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `43` | `8` | `0` | `0` | `35` | no |
