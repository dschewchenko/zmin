...
| Git doc option pairs represented by rows | `250/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `1072` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `810/1072` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1072` | no | written rows with incomplete parity |
| Open written rows | `1/1072` | no | written rows that still do not match stock Git |
...
| Getting and Creating Projects | `2` | `0` | `66` | `0` | `6` | `4` | `0` | `1` | `1` | `2` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1072`** | **`810`** | **`0`** | **`1`** | **`261`** | **`683`** |
...
Never use `151/151` command presence, `4632` option spellings, `250/4632`
represented option pairs or `810/1072` passing written rows as a Git support
percentage. The `810/1072` number is audit progress for supported rows already
written down; `0/1072` rows are partial, `1/1072` rows are open and `261/1072`
...
| `clone` | `56` | `0` | `2` | `docs/cli/matrices/clone_v2_47.tsv` | `4` | `2` | `0` | `1` | `1` | no |
