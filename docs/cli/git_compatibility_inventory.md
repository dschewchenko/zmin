...
| Written behavior rows | `836` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `732/836` | yes, row by row | supported-behavior rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `80` | `66` | `0` | `0` | `14` | `95` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`836`** | **`732`** | **`0`** | **`0`** | **`104`** | **`500`** |
...
represented option pairs or `732/836` passing written rows as a Git support
percentage. The `732/836` number is audit progress for supported rows already
written down; `104/836` additional rows are stock-compatible invalid inputs. It
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `74` | `66` | `0` | `0` | `8` | no |
