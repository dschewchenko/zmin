...
| Written behavior rows | `1075` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `811/1075` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1075` | no | written rows with incomplete parity |
| Open written rows | `1/1075` | no | written rows that still do not match stock Git |
| Invalid input rows | `263/1075` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `84` | `66` | `0` | `0` | `18` | `99` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1075`** | **`811`** | **`0`** | **`1`** | **`263`** | **`683`** |
...
represented option pairs or `811/1075` passing written rows as a Git support
percentage. The `811/1075` number is audit progress for supported rows already
written down; `0/1075` rows are partial, `1/1075` rows are open and `263/1075`
...
| --- | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `add` | `34` | `0` | `0` | `docs/cli/matrices/add_v2_47.tsv` | `2` | `0` | `0` | `0` | `2` | no |
