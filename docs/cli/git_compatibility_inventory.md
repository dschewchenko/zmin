...
| Written behavior rows | `1092` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `822/1092` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1092` | no | written rows with incomplete parity |
| Open written rows | `1/1092` | no | written rows that still do not match stock Git |
| Invalid input rows | `269/1092` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `154` | `148` | `0` | `0` | `6` | `26` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1092`** | **`822`** | **`0`** | **`1`** | **`269`** | **`691`** |
...
represented option pairs or `822/1092` passing written rows as a Git support
percentage. The `822/1092` number is audit progress for supported rows already
written down; `0/1092` rows are partial, `1/1092` rows are open and `269/1092`
...
| `diff` | `133` | `0` | `31` | `docs/cli/matrices/diff_v2_47.tsv` | `67` | `66` | `0` | `0` | `1` | no |
