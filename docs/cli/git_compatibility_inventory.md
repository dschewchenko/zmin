...
| Written behavior rows | `1949` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1640/1949` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1949` | no | written rows with incomplete parity |
| Open written rows | `1/1949` | no | written rows that still do not match stock Git |
| Invalid input rows | `308/1949` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Plumbing Commands | `21` | `0` | `650` | `0` | `469` | `402` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `106` | `72` | `0` | `0` | `34` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1949`** | **`1640`** | **`0`** | **`1`** | **`308`** | **`1018`** |
...
represented option pairs or `1640/1949` passing written rows as a Git support
percentage. The `1640/1949` number is audit progress for supported rows already
written down; `0/1949` rows are partial, `1/1949` rows are open and `308/1949`
