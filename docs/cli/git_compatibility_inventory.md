...
| Written behavior rows | `1053` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `790/1053` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `2/1053` | no | written rows with incomplete parity |
| Open written rows | `0/1053` | no | written rows that still do not match stock Git |
...
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `46` | `17` | `2` | `0` | `27` | `39` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1053`** | **`790`** | **`2`** | **`0`** | **`261`** | **`683`** |
...
represented option pairs or `790/1053` passing written rows as a Git support
percentage. The `790/1053` number is audit progress for supported rows already
written down; `2/1053` rows are partial and `261/1053` additional rows are
...
| `fast-import` | `25` | `0` | `1` | `docs/cli/matrices/fast_import_v2_47.tsv` | `5` | `0` | `2` | `0` | `3` | no |
