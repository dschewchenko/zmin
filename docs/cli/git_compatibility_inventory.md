...
| Written behavior rows | `1049` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `787/1049` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1049` | no | written rows with incomplete parity |
| Open written rows | `0/1049` | no | written rows that still do not match stock Git |
...
| Getting and Creating Projects | `2` | `0` | `66` | `0` | `1` | `0` | `0` | `0` | `1` | `2` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1049`** | **`787`** | **`1`** | **`0`** | **`261`** | **`683`** |
...
represented option pairs or `787/1049` passing written rows as a Git support
percentage. The `787/1049` number is audit progress for supported rows already
written down; `1/1049` row is partial and `261/1049` additional rows are
...
| `clone` | `56` | `0` | `0` | `docs/cli/matrices/clone_v2_47.tsv` | `1` | `0` | `0` | `0` | `1` | no |
