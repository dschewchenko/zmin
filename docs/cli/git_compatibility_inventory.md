...
| Written behavior rows | `767` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `691/767` | yes, row by row | exact written rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `63` | `59` | `0` | `0` | `4` | `68` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `165` | `135` | `0` | `0` | `30` | `89` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`767`** | **`691`** | **`0`** | **`0`** | **`76`** | **`435`** |
...
represented option pairs or `691/767` passing written rows as a Git support
percentage. The `691/767` number is audit progress for rows already written
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `63` | `59` | `0` | `0` | `4` | no |
...
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `42` | `38` | `0` | `0` | `4` | no |
