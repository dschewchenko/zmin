...
| Written behavior rows | `900` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `742/900` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `50` | `8` | `0` | `0` | `42` | `102` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`900`** | **`742`** | **`0`** | **`0`** | **`158`** | **`550`** |
...
represented option pairs or `742/900` passing written rows as a Git support
percentage. The `742/900` number is audit progress for supported rows already
written down; `158/900` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `6` | `docs/cli/matrices/blame_v2_47.tsv` | `49` | `8` | `0` | `0` | `41` | no |
