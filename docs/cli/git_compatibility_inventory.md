...
| Written behavior rows | `1016` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `777/1016` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `1/1016` | no | written rows with incomplete parity |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `63` | `38` | `0` | `0` | `25` | `32` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1016`** | **`777`** | **`1`** | **`0`** | **`238`** | **`650`** |
...
represented option pairs or `777/1016` passing written rows as a Git support
percentage. The `777/1016` number is audit progress for supported rows already
written down; `1/1016` row is partial and `238/1016` additional rows are
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `3` | `3` | `0` | `0` | `0` | no |
