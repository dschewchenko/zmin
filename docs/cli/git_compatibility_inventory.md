...
| Written behavior rows | `762` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `686/762` | yes, row by row | exact written rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `62` | `58` | `0` | `0` | `4` | `67` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `161` | `131` | `0` | `0` | `30` | `85` |
| Other Git 2.47 commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `0` | `1` | `4` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`762`** | **`686`** | **`0`** | **`0`** | **`76`** | **`430`** |
...
represented option pairs or `686/762` passing written rows as a Git support
percentage. The `686/762` number is audit progress for rows already written
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `62` | `58` | `0` | `0` | `4` | no |
...
| `rev-parse` | `72` | `0` | `24` | `docs/cli/matrices/rev_parse_v2_47.tsv` | `38` | `34` | `0` | `0` | `4` | no |
