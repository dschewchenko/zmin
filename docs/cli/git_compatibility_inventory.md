...
| Git doc option pairs represented by rows | `231/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `833` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `732/833` | yes, row by row | supported-behavior rows with parity evidence |
...
| Basic Snapshotting | `9` | `0` | `371` | `0` | `77` | `66` | `0` | `0` | `11` | `92` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`833`** | **`732`** | **`0`** | **`0`** | **`101`** | **`497`** |
...
Never use `151/151` command presence, `4632` option spellings, `231/4632`
represented option pairs or `732/833` passing written rows as a Git support
percentage. The `732/833` number is audit progress for supported rows already
written down; `101/833` additional rows are stock-compatible invalid inputs. It
...
| `status` | `26` | `0` | `22` | `docs/cli/matrices/status_v2_47.tsv` | `71` | `66` | `0` | `0` | `5` | no |
