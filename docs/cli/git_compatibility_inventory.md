...
| Git doc option pairs represented by rows | `227/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `827` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `727/827` | yes, row by row | supported-behavior rows with parity evidence |
...
| Debugging | `3` | `0` | `132` | `0` | `3` | `0` | `0` | `0` | `3` | `55` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`827`** | **`727`** | **`0`** | **`0`** | **`100`** | **`491`** |
...
Never use `151/151` command presence, `4632` option spellings, `227/4632`
represented option pairs or `727/827` passing written rows as a Git support
percentage. The `727/827` number is audit progress for supported rows already
written down; `100/827` additional rows are stock-compatible invalid inputs. It
...
| `blame` | `39` | `0` | `1` | `docs/cli/matrices/blame_v2_47.tsv` | `2` | `0` | `0` | `0` | `2` | no |
