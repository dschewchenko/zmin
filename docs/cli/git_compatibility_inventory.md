...
| Written behavior rows | `2045` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `1734/2045` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2045` | no | written rows with incomplete parity |
| Open written rows | `1/2045` | no | written rows that still do not match stock Git |
| Invalid input rows | `310/2045` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Debugging | `3` | `0` | `132` | `0` | `124` | `43` | `0` | `0` | `81` | `166` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2045`** | **`1734`** | **`0`** | **`1`** | **`310`** | **`1018`** |
...
represented option pairs or `1734/2045` passing written rows as a Git support
percentage. The `1734/2045` number is audit progress for supported rows already
written down; `0/2045` rows are partial, `1/2045` rows are open and `310/2045`
...
| `blame` | `39` | `0` | `14` | `docs/cli/matrices/blame_v2_47.tsv` | `111` | `31` | `0` | `0` | `80` | no |
