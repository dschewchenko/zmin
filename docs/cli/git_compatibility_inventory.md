...
| Written behavior rows | `719` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `643/719` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `253` | `247` | `0` | `0` | `6` | `138` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`719`** | **`643`** | **`0`** | **`0`** | **`76`** | **`410`** |
...
represented option pairs or `643/719` passing written rows as a Git support
percentage. The `643/719` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `253` | `247` | `0` | `0` | `6` | no |
