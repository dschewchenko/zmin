...
| Written behavior rows | `2610` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2233/2610` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2610` | no | written rows with incomplete parity |
| Open written rows | `1/2610` | no | written rows that still do not match stock Git |
| Invalid input rows | `376/2610` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Administration | `8` | `0` | `147` | `0` | `133` | `72` | `0` | `0` | `61` | `58` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2610`** | **`2233`** | **`0`** | **`1`** | **`376`** | **`1018`** |
...
represented option pairs or `2233/2610` passing written rows as a Git support
percentage. The `2233/2610` number is audit progress for supported rows already
written down; `0/2610` rows are partial, `1/2610` rows are open and `376/2610`
...
| `maintenance` | `14` | `0` | `4` | `docs/cli/matrices/maintenance_v2_47.tsv` | `13` | `7` | `0` | `0` | `6` | no |
