...
| Written rows matching stock Git | `625/700` | yes, row by row | exact written rows with parity evidence |
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `240` | `233` | `0` | `2` | `5` | `130` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`700`** | **`625`** | **`0`** | **`2`** | **`73`** | **`396`** |
...
represented option pairs or `625/700` passing written rows as a Git support
percentage. The `625/700` number is audit progress for rows already written
...
| `fetch` | `73` | `0` | `30` | `docs/cli/matrices/fetch_v2_47.tsv` | `240` | `233` | `0` | `2` | `5` | no |
