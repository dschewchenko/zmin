...
| Git doc option pairs represented by rows | `631/4632` | no | documented command-option pairs with at least one behavior row |
| Written behavior rows | `2687` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `2300/2687` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/2687` | no | written rows with incomplete parity |
| Open written rows | `1/2687` | no | written rows that still do not match stock Git |
| Invalid input rows | `386/2687` | yes, as invalid-input compatibility | rows where stock Git rejects the input and Zmin matches that rejection |
...
| Administration | `8` | `0` | `147` | `0` | `150` | `89` | `0` | `0` | `61` | `58` |
| Server Admin | `2` | `0` | `30` | `0` | `2` | `2` | `0` | `0` | `0` | `0` |
| Plumbing Commands | `21` | `0` | `650` | `0` | `515` | `448` | `0` | `0` | `67` | `186` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `161` | `124` | `0` | `0` | `37` | `102` |
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2687`** | **`2300`** | **`0`** | **`1`** | **`386`** | **`1018`** |
...
Never use `151/151` command presence, `4632` option spellings, `631/4632`
represented option pairs or `2300/2687` passing written rows as a Git support
percentage. The `2300/2687` number is audit progress for supported rows already
written down; `0/2687` rows are partial, `1/2687` rows are open and `386/2687`
...
| `request-pull` | `1` | `0` | `0` | `docs/cli/matrices/request_pull_v2_47.tsv` | `1` | `1` | `0` | `0` | `0` | no |
