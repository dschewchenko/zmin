...
| Written behavior rows | `1060` | no by itself | explicit command/option/value/combination/state/transport/platform rows currently written |
| Written rows matching stock Git | `799/1060` | yes, row by row | supported-behavior rows with parity evidence |
| Partial written rows | `0/1060` | no | written rows with incomplete parity |
| Open written rows | `0/1060` | no | written rows that still do not match stock Git |
...
| Branching and Merging | `9` | `0` | `581` | `0` | `75` | `46` | `0` | `0` | `29` | `45` |
...
| **Git 2.47 unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1060`** | **`799`** | **`0`** | **`0`** | **`261`** | **`683`** |
...
represented option pairs or `799/1060` passing written rows as a Git support
percentage. The `799/1060` number is audit progress for supported rows already
written down; `0/1060` rows are partial and `261/1060` additional rows are
...
| `stash` | `30` | `0` | `0` | `docs/cli/matrices/stash_v2_47.tsv` | `15` | `11` | `0` | `0` | `4` | no |
