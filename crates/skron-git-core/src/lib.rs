//! From-scratch Git-compatible core primitives for Skron.
//!
//! This crate does not depend on the existing encrypted `skron-git` prototype.
...
pub use attributes::{AttributeValue, GitAttributes};
pub use checkout::{
