...
mod tests {
    ...
    fn commit_encode_initial_capacity_is_bounded() {
        ...
        let author = Signature::new("Zmin Test", "zmin@example.com", 1_700_000_000, "+0000")
            .expect("author");
        let committer = Signature::new("Zmin Test", "zmin@example.com", -1_700_000_000, "+0000")
            .expect("committer");
    ...
    fn commit_object_is_readable_by_stock_git() {
        ...
        assert!(rendered.contains("author Zmin Test <zmin@example.com> 1700000000 +0000"));
        assert!(rendered.contains("committer Zmin Test <zmin@example.com> 1700000000 +0000"));
    ...
    fn decodes_stock_commit_tree_parents_and_message() {
        let repo = git_init();
        git(&repo, ["config", "user.name", "Zmin Test"]);
        git(&repo, ["config", "user.email", "zmin@example.com"]);
