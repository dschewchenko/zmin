...
fn for_each_rev_list_tree_object_line(
    ...
    struct PendingTreeLine {
        id: ObjectId,
        path_len: usize,
        entries: Option<Arc<[skron_git_core::TreeEntry]>>,
        next: usize,
    }
...
fn parse_commit_full_object_id_if_commit(
    ...
    for _ in 0..8 {
        ...
        match object.kind {
            ...
            GitObjectKind::Tag => {
                object_id =
                    skron_git_core::decode_tag(GitHashAlgorithm::Sha1, &object.content)?.target;
            }
            _ => {
                return Ok(None);
            }
...
mod tests {
    ...
    use skron_git_core::{CommitBuilder, GitObjectSink, Signature, TreeEntry, encode_tree};
