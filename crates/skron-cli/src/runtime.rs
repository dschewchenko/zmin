...
pub(crate) use crate::cli::commands::{
    admin_commands, archive_commands, commit_commands, config_commands, core_commands,
    credential_commands, diff_commands, grep_commands, history_commands, import_commands,
    mail_commands, maintenance_commands, merge_commands, notes_commands, pack_commands,
    patch_commands, reference_commands, scalar_commands, sequencer_commands, text_commands,
    transport_commands, worktree_commands,
};
