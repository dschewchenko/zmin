...
#[derive(Parser, Debug)]
#[command(version, about = "Thin Git-compatible CLI over skron-git-core")]
...
pub(crate) enum Command {
    ...
    Compatibility {
        #[arg(long, value_enum, default_value_t = compat::CompatProfile::V2_32)]
        profile: compat::CompatProfile,
        #[arg(long, value_enum, default_value_t = compat::CompatFormat::Text)]
        format: compat::CompatFormat,
    },
    Init {
    ...
    CatFile {
        ...
        exists: bool,
        #[arg(long = "batch-check", action = ArgAction::SetTrue)]
        batch_check: bool,
        #[arg(long = "batch", action = ArgAction::SetTrue)]
        batch: bool,
        #[arg(long = "batch-command", action = ArgAction::SetTrue)]
        batch_command: bool,
    ...
    Status {
        #[arg(long = "porcelain", num_args = 0..=1, default_missing_value = "v1")]
    ...
    Diff {
        ...
        #[arg(long = "abbrev", num_args = 0..=1, default_missing_value = "")]
...
pub(crate) struct ScalarCloneArgs {
    ...
    pub(crate) no_src: Option<String>,
    ...
    pub(crate) no_tags: Option<String>,
    #[arg(long = "maintenance", num_args = 0..=1, default_missing_value = "", require_equals = true, overrides_with = "no_maintenance")]
    pub(crate) maintenance: Option<String>,
    #[arg(long = "no-maintenance", num_args = 0..=1, default_missing_value = "", require_equals = true, overrides_with = "maintenance")]
    pub(crate) no_maintenance: Option<String>,
    pub(crate) url: Option<String>,
    #[arg(value_hint = ValueHint::DirPath, allow_hyphen_values = true)]
    pub(crate) enlistment: Option<PathBuf>,
}
...
#[derive(Subcommand, Debug)]
pub(crate) enum CommitGraphCommand {
    Write {
...
#[derive(Subcommand, Debug)]
pub(crate) enum MultiPackIndexCommand {
    Write {
        #[arg(long = "progress", action = ArgAction::SetTrue)]
        progress: bool,
        #[arg(long = "no-progress", action = ArgAction::SetTrue)]
...
pub(crate) struct LsFilesOptions {
    ...
    pub(crate) empty_directory: bool,
    pub(crate) ignored: bool,
    pub(crate) excludes: Vec<String>,
    pub(crate) exclude_from: Vec<PathBuf>,
    pub(crate) exclude_per_directory: Option<String>,
    pub(crate) exclude_standard: bool,
    pub(crate) zero: bool,
    pub(crate) full_name: bool,
    pub(crate) error_unmatch: bool,
    pub(crate) tagged: bool,
    pub(crate) lowercase_assume_valid: bool,
    pub(crate) fsmonitor_clean: bool,
    ...
    pub(crate) with_tree: Option<String>,
    pub(crate) resolve_undo: bool,
    pub(crate) path_args: Vec<PathBuf>,
}
...
pub(crate) struct RmOptions {
    ...
    pub(crate) cached: bool,
    pub(crate) ignore_unmatch: bool,
    pub(crate) pathspec_from_file: Option<PathBuf>,
...
pub(crate) struct ConfigArgs {
    ...
    pub(crate) int_value: bool,
    pub(crate) bool_or_int_value: bool,
    pub(crate) bool_or_str_value: bool,
    pub(crate) path_value: bool,
    pub(crate) expiry_date_value: bool,
...
pub(crate) struct DiffOptions {
    ...
    pub(crate) break_rewrites: Option<String>,
    pub(crate) irreversible_delete: bool,
    pub(crate) submodule: Option<String>,
    pub(crate) ignore_submodules: Option<String>,
    pub(crate) find_copies: Option<String>,
    pub(crate) find_copies_harder: bool,
    pub(crate) no_renames: bool,
    pub(crate) pickaxe_string: Option<String>,
    pub(crate) pickaxe_regex: Option<String>,
    pub(crate) pickaxe_regex_mode: bool,
    pub(crate) pickaxe_all: bool,
    pub(crate) order_file: Option<PathBuf>,
    pub(crate) skip_to: Option<String>,
    pub(crate) rotate_to: Option<String>,
    pub(crate) diff_filter: Option<String>,
    pub(crate) word_diff: Option<String>,
    pub(crate) abbrev: Option<String>,
    pub(crate) no_abbrev: bool,
    pub(crate) full_index: bool,
    pub(crate) no_full_index: bool,
    pub(crate) no_prefix: bool,
    pub(crate) default_prefix: bool,
    pub(crate) src_prefix: Option<String>,
    pub(crate) dst_prefix: Option<String>,
    pub(crate) relative: Option<String>,
    pub(crate) no_relative: bool,
    pub(crate) unified: Option<String>,
    pub(crate) inter_hunk_context: Option<String>,
    pub(crate) minimal: bool,
    pub(crate) patience: bool,
    pub(crate) histogram: bool,
    pub(crate) diff_algorithm: Option<String>,
    pub(crate) anchored: Vec<String>,
    pub(crate) output_indicator_new: Option<String>,
    pub(crate) output_indicator_old: Option<String>,
    pub(crate) output_indicator_context: Option<String>,
    pub(crate) ignore_space_at_eol: bool,
    pub(crate) ignore_cr_at_eol: bool,
    ...
    pub(crate) no_textconv: bool,
    pub(crate) text: bool,
    pub(crate) color: Option<String>,
    pub(crate) no_color: bool,
    pub(crate) no_color_moved: bool,
    pub(crate) no_color_moved_ws: bool,
    pub(crate) quiet: bool,
...
#[derive(Debug, Clone)]
pub(crate) struct PlumbingDiffOptions {
    pub(crate) recursive: bool,
    pub(crate) nul_terminated: bool,
    ...
    pub(crate) new_treeish: Option<String>,
    pub(crate) cached: bool,
    pub(crate) paths: Vec<PathBuf>,
}

#[derive(Debug, Clone)]
pub(crate) struct DiffPairsOptions {
    pub(crate) nul_terminated: bool,
    pub(crate) patch: bool,
    pub(crate) no_patch: bool,
    pub(crate) stat: bool,
...
#[derive(Debug, Clone)]
pub(crate) struct InterpretTrailersOptions<'a> {
    pub(crate) in_place: bool,
    pub(crate) trim_empty: bool,
    pub(crate) where_: Option<&'a str>,
    pub(crate) if_exists: Option<&'a str>,
    pub(crate) if_missing: Option<&'a str>,
    pub(crate) only_trailers: bool,
    pub(crate) only_input: bool,
    pub(crate) unfold: bool,
    pub(crate) no_divider: bool,
    pub(crate) trailers: Vec<String>,
    pub(crate) files: Vec<PathBuf>,
}

#[derive(Debug, Clone)]
pub(crate) struct MergeTreeOptions {
    pub(crate) write_tree: bool,
    pub(crate) trivial_merge: bool,
...
#[derive(Debug, Clone)]
pub(crate) struct IndexPackOptions {
    pub(crate) stdin: bool,
    pub(crate) output: Option<PathBuf>,
    pub(crate) keep: Option<String>,
    pub(crate) rev_index: bool,
    pub(crate) no_rev_index: bool,
    pub(crate) verify: bool,
    pub(crate) strict: Option<String>,
    pub(crate) fsck_objects: Option<String>,
    pub(crate) fix_thin: bool,
    pub(crate) verbose: bool,
    pub(crate) index_version: Option<String>,
    pub(crate) pack_file: Option<PathBuf>,
}

#[derive(Debug, Clone)]
pub(crate) struct PackObjectsOptions {
    ...
    pub(crate) no_reuse_object: bool,
    pub(crate) delta_base_offset: bool,
    pub(crate) window: Option<usize>,
    pub(crate) depth: Option<usize>,
    pub(crate) base_name: Option<PathBuf>,
}
