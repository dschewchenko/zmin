pub const STRINGS: &[(&str, &str)] = &[
    (
        "login_connecting",
        "Connecting to Skron authentication service at {url}...",
    ),
    (
    ...
    (
        ...
        "No local identity found for {email} on {server}; run `skron login`.",
    ),
    (
        "publish_no_changes",
    ...
    (
        ...
        "Okay, nothing was staged. Use `skron stage <file>` and run `skron publish` again.",
    ),
    (
    ...
    (
        ...
        "Run `skron publish` when you're happy with the pending list.",
    ),
