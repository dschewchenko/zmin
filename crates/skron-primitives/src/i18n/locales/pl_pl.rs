pub const STRINGS: &[(&str, &str)] = &[
    (
        "login_connecting",
        "Łączenie z serwisem uwierzytelniania Skron pod adresem {url}...",
    ),
    (
    ...
    (
        ...
        "Nie znaleziono lokalnej tożsamości dla {email} na {server}; uruchom `skron login`.",
    ),
    (
        "publish_no_changes",
    ...
    (
        ...
        "Nic nie zostało dodane. Użyj `skron stage <plik>` i ponownie uruchom `skron publish`.",
    ),
    (
    ...
    (
        ...
        "Gdy lista będzie gotowa, uruchom `skron publish`.",
    ),
    (
        "sync_checking",
