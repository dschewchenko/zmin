...
fn normalize_show_similarity_operand(option: &mut Option<String>, args: &mut Vec<String>) {
    ...
    if is_similarity_threshold_value(value) {
        return;
    }
    let consumed = option.take().expect("show similarity option value");
    args.insert(0, consumed);
...
pub(crate) fn dispatch(
    ...
    match command {
        ...
        runtime::Command::Whatchanged {
            ...
            if i_still_use_this {
                return Err(runtime::CliError::Fatal {
                    code: 128,
                    message: "unrecognized argument: --i-still-use-this".into(),
                });
            }
            super::history_commands::log(super::history_commands::LogOptions {
                oneline,
        ...
        runtime::Command::Show(runtime::ShowCommandArgs {
            no_patch,
            patch,
            oneline,
            zero,
            ...
            let mut find_renames = find_renames;
            let mut find_copies = find_copies;
            ...
            super::history_commands::show(super::history_commands::ShowOptions {
                ...
                name_only,
                name_status,
                find_renames: find_renames.as_deref(),
                find_copies: find_copies.as_deref(),
                find_copies_harder,
                encoding: encoding.as_deref(),
                expand_tabs,
                no_expand_tabs,
