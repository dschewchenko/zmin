...
#[test]
fn checkout_path_modifier_family_matches_stock_git() {
    for args in [
        ["checkout", "--guess", "."].as_slice(),
        ["checkout", "--no-guess", "."].as_slice(),
...
#[test]
fn checkout_track_family_matches_stock_git_invalid_input() {
    for args in [
        ...
        ["checkout", "--no-track", "a.txt"].as_slice(),
        ["checkout", "--track", "--", "a.txt"].as_slice(),
        ["checkout", "-t", "--", "a.txt"].as_slice(),
        ["checkout", "--no-track", "--", "a.txt"].as_slice(),
    ] {
...
fn checkout_negated_pathspec_file_flags_match_stock_git() {
    for args in [
        ...
        .as_slice(),
        ["checkout", "--no-pathspec-file-nul", "a.txt"].as_slice(),
        [
            "checkout",
