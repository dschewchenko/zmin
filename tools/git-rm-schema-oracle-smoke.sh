...
run_case rm_invalid_short_zero rm -0 tracked.txt
run_case rm_invalid_short_all rm -A tracked.txt
run_case rm_invalid_short_a rm -a tracked.txt
run_case rm_invalid_short_update rm -u tracked.txt
run_case rm_invalid_short_z rm -z tracked.txt
