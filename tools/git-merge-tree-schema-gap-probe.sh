...
run_exact merge_tree_strategy_option_short_theirs "" --write-tree -X theirs "$ours_commit" "$theirs_commit"
run_invalid merge_tree_strategy_option_short_equals_invalid "" --write-tree -X=ours "$ours_commit" "$theirs_commit"
run_invalid merge_tree_strategy_option_short_equals_theirs_invalid "" --write-tree -X=theirs "$ours_commit" "$theirs_commit"
