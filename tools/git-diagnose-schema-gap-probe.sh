...
text = re.sub(r"^git version .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^cpu: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^no commit associated with this build\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^sizeof-long: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^sizeof-size_t: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^shell-path: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^feature: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^libcurl: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^default-ref-format: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^zmin-version: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^zlib: .*\n", "", text, flags=re.MULTILINE)
text = re.sub(r"^SHA-1: .*\n", "", text, flags=re.MULTILINE)
