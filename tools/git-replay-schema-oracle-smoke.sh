...
run_case replay_bisect_all arg replay --bisect-all --advance topic "$range"
run_case replay_bisect_vars arg replay --bisect-vars --advance topic "$range"
...
run_case replay_boundary arg replay --boundary --advance topic "$range"
run_case replay_commit_header arg replay --commit-header --advance topic "$range"
run_case replay_disk_usage arg replay --disk-usage --advance topic "$range"
run_case replay_encoding_utf8 arg replay --encoding=UTF-8 --advance topic "$range"
run_case replay_exclude_promisor_objects arg replay --exclude-promisor-objects --advance topic "$range"
run_case replay_filter_requires_objects arg replay --filter=blob:none --advance topic "$range"
run_case replay_filter_print_omitted arg replay --filter-print-omitted --advance topic "$range"
run_case replay_filter_provided_objects arg replay --filter-provided-objects --advance topic "$range"
run_case replay_grep_two arg replay --grep=two --advance topic "$range"
run_case replay_grep_reflog_requires_walk arg replay --grep-reflog=topic --advance topic "$range"
run_case replay_graph_reverse_conflict arg replay --graph --advance topic "$range"
run_case replay_header arg replay --header --advance topic "$range"
...
run_case replay_merge_requires_pseudoref arg replay --merge --advance topic "$range"
run_case replay_missing_print arg replay --missing=print --advance topic "$range"
run_case replay_no_commit_header arg replay --no-commit-header --advance topic "$range"
run_case replay_no_filter arg replay --no-filter --advance topic "$range"
run_case replay_no_object_names arg replay --no-object-names --advance topic "$range"
run_case replay_object_names arg replay --object-names --advance topic "$range"
...
run_case replay_progress_value arg replay --progress=1 --advance topic "$range"
...
run_case replay_show_pulls arg replay --show-pulls --advance topic "$range"
run_case replay_dense arg replay --dense --advance topic "$range"
run_case replay_sparse arg replay --sparse --advance topic "$range"
run_case replay_timestamp arg replay --timestamp --advance topic "$range"
...
run_case replay_use_bitmap_index arg replay --use-bitmap-index --advance topic "$range"
...
run_case replay_walk_reflogs arg replay --walk-reflogs --advance topic "$range"
run_case replay_walk_reflogs_short arg replay -g --advance topic "$range"
...
run_case replay_short_n_not_integer arg replay -n "$range" --advance topic
...
run_case replay_glob_multiple_sources arg replay --glob=refs/heads/\* --advance topic "$range"
run_case replay_left_only_empty_selection arg replay --left-only --advance topic "$range"
run_case replay_merges_empty_selection arg replay --merges --advance topic "$range"
run_case replay_min_age_empty_selection arg replay --min-age=0 --advance topic "$range"
