...
run_case diff_files_color_moved diff-files -p --color-moved
run_case diff_files_color_moved_ws diff-files -p --color-moved-ws=ignore-space-change
...
run_case diff_files_ext_diff diff-files -p --ext-diff
...
run_case diff_files_indent_heuristic diff-files -p --indent-heuristic
...
run_case diff_files_no_indent_heuristic diff-files -p --no-indent-heuristic
run_case diff_files_no_full_index diff-files --raw --no-full-index
run_case diff_files_no_rename_empty diff-files --name-status --no-rename-empty
...
run_case diff_files_rename_empty diff-files --name-status --rename-empty
...
run_case diff_files_textconv diff-files -p --textconv
