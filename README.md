...
| Behavior rows written | `147` | explicit command/option/value/state/transport/platform rows in the current matrix |
| Behavior rows closed | `132/147` | exact written rows that match stock Git by focused evidence |
...
| Sharing and Updating Projects | `5` | `309` | `87` | `76` | `9` | `2` |
...
| **Git `2.47` unique total** | **`151`** | **`4632`** | **`147`** | **`132`** | **`9`** | **`6`** |
