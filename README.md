...
| Written rows matching stock Git | `625/706` | exact written rows with focused parity evidence |
| Open written rows | `7/706` | written rows that still do not match stock Git |
...
Do not read `625/706` as Git compatibility. It only means `625` of the `706`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `246` | `233` | `7` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`706`** | **`625`** | **`7`** | **`74`** |
...
| `fetch` | `73` | `0` | `30` | `246` | `233` | `0` | `7` | `6` | no |
