...
| Written behavior rows | `734` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `658/734` | exact written rows with focused parity evidence |
| Open written rows | `0/734` | written rows that still do not match stock Git |
| Invalid input rows | `76/734` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `658/734` as Git compatibility. It only means `658` of the `734`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `268` | `262` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`734`** | **`658`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `268` | `262` | `0` | `0` | `6` | no |
