...
| Written behavior rows | `2286` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `1964/2286` | supported-behavior rows with focused parity evidence |
| Partial written rows | `0/2286` | written rows with incomplete parity |
| Open written rows | `1/2286` | written rows that still do not match stock Git |
| Invalid input rows | `321/2286` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `1964/2286` as Git compatibility. It only means `1964` of the `2286`
rows already written down are closed supported-behavior rows. The larger
unexpanded surface is not counted yet, `0/2286` rows are partially matching,
`1/2286` rows are known open mismatches, and `321/2286` additional rows are
...
| Branching and Merging | `9` | `0` | `581` | `0` | `229` | `191` | `0` | `0` | `38` |
...
| Administration | `8` | `0` | `147` | `0` | `77` | `52` | `0` | `0` | `25` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2286`** | **`1964`** | **`0`** | **`1`** | **`321`** |
...
| `stash` | `30` | `0` | `0` | `168` | `156` | `0` | `0` | `12` | no |
