...
| Written rows matching stock Git | `624/700` | exact written rows with focused parity evidence |
| Open written rows | `3/700` | written rows that still do not match stock Git |
...
Do not read `624/700` as Git compatibility. It only means `624` of the `700`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `240` | `232` | `3` | `5` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`700`** | **`624`** | **`3`** | **`73`** |
...
| `fetch` | `73` | `0` | `30` | `240` | `232` | `0` | `3` | `5` | no |
