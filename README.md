...
| Written behavior rows | `239` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `224/239` | exact written rows with focused parity evidence |
| Open written rows | `9/239` | written rows that still do not match stock Git |
| Invalid input rows | `6/239` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `224/239` as Git compatibility. It only means `224` of the `239`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `179` | `168` | `9` | `2` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`239`** | **`224`** | **`9`** | **`6`** |
...
| `fetch` | `73` | `0` | `28` | `179` | `168` | `0` | `9` | `2` | no |
