...
| Written behavior rows | `729` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `653/729` | exact written rows with focused parity evidence |
| Open written rows | `0/729` | written rows that still do not match stock Git |
| Invalid input rows | `76/729` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `653/729` as Git compatibility. It only means `653` of the `729`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `263` | `257` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`729`** | **`653`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `263` | `257` | `0` | `0` | `6` | no |
