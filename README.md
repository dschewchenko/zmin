...
| Behavior rows written | `139` | explicit command/option/value/state/transport/platform rows in the current matrix |
| Behavior rows closed | `124/139` | exact written rows that match stock Git by focused evidence |
...
| Sharing and Updating Projects | `5` | `309` | `79` | `68` | `9` | `2` |
...
| **Git `2.47` unique total** | **`151`** | **`4632`** | **`139`** | **`124`** | **`9`** | **`6`** |
