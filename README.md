...
| Written behavior rows | `617` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `540/617` | exact written rows with focused parity evidence |
| Open written rows | `9/617` | written rows that still do not match stock Git |
| Invalid input rows | `68/617` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `540/617` as Git compatibility. It only means `540` of the `617`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `192` | `180` | `9` | `3` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`617`** | **`540`** | **`9`** | **`68`** |
...
| `fetch` | `73` | `0` | `28` | `192` | `180` | `0` | `9` | `3` | no |
