...
| Written rows matching stock Git | `590/665` | exact written rows with focused parity evidence |
| Open written rows | `4/665` | written rows that still do not match stock Git |
...
Do not read `590/665` as Git compatibility. It only means `590` of the `665`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `205` | `198` | `4` | `3` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`665`** | **`590`** | **`4`** | **`71`** |
...
| `fetch` | `73` | `0` | `28` | `205` | `198` | `0` | `4` | `3` | no |
