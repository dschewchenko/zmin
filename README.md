...
| Written behavior rows | `738` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `662/738` | exact written rows with focused parity evidence |
| Open written rows | `0/738` | written rows that still do not match stock Git |
| Invalid input rows | `76/738` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `662/738` as Git compatibility. It only means `662` of the `738`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `272` | `266` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`738`** | **`662`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `272` | `266` | `0` | `0` | `6` | no |
