...
| Written behavior rows | `736` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `660/736` | exact written rows with focused parity evidence |
| Open written rows | `0/736` | written rows that still do not match stock Git |
| Invalid input rows | `76/736` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `660/736` as Git compatibility. It only means `660` of the `736`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `270` | `264` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`736`** | **`660`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `270` | `264` | `0` | `0` | `6` | no |
