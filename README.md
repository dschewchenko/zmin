...
| Written rows matching stock Git | `794/1055` | supported-behavior rows with focused parity evidence |
| Partial written rows | `0/1055` | written rows with incomplete parity |
...
Do not read `794/1055` as Git compatibility. It only means `794` of the `1055`
rows already written down are closed supported-behavior rows. The larger
unexpanded surface is not counted yet, `0/1055` rows are partially matching,
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1055`** | **`794`** | **`0`** | **`0`** | **`261`** |
