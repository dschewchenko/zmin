...
| Written rows matching stock Git | `626/706` | exact written rows with focused parity evidence |
| Open written rows | `6/706` | written rows that still do not match stock Git |
...
Do not read `626/706` as Git compatibility. It only means `626` of the `706`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `246` | `234` | `6` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`706`** | **`626`** | **`6`** | **`74`** |
...
| `fetch` | `73` | `0` | `30` | `246` | `234` | `0` | `6` | `6` | no |
