...
Current preview: [`v0.0.1-preview.20260619T141129Z`](https://github.com/dschewchenko/zmin/releases/tag/v0.0.1-preview.20260619T141129Z)
...
```bash
mkdir -p ~/.local/bin
curl -L https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-aarch64-apple-darwin.tar.gz | tar -xz
...
```bash
mkdir -p ~/.local/bin
curl -L https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-x86_64-apple-darwin.tar.gz | tar -xz
install -m 0755 zmin ~/.local/bin/zmin
zmin --version
```
...
```bash
mkdir -p ~/.local/bin
curl -L https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-x86_64-unknown-linux-gnu.tar.gz | tar -xz
install -m 0755 zmin ~/.local/bin/zmin
zmin --version
```
...
```bash
mkdir -p ~/.local/bin
curl -L https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-aarch64-unknown-linux-gnu.tar.gz | tar -xz
install -m 0755 zmin ~/.local/bin/zmin
zmin --version
```
...
```powershell
$Version = "v0.0.1-preview.20260619T141129Z"
...
- [`zmin-x86_64-unknown-linux-gnu.tar.gz`](https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-x86_64-unknown-linux-gnu.tar.gz)
- [`zmin-aarch64-unknown-linux-gnu.tar.gz`](https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-aarch64-unknown-linux-gnu.tar.gz)
- [`zmin-x86_64-apple-darwin.tar.gz`](https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-x86_64-apple-darwin.tar.gz)
- [`zmin-aarch64-apple-darwin.tar.gz`](https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-aarch64-apple-darwin.tar.gz)
- [`zmin-x86_64-pc-windows-msvc.zip`](https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-x86_64-pc-windows-msvc.zip)
- [`zmin-aarch64-pc-windows-msvc.zip`](https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/zmin-aarch64-pc-windows-msvc.zip)
- [`SHA256SUMS`](https://github.com/dschewchenko/zmin/releases/download/v0.0.1-preview.20260619T141129Z/SHA256SUMS)
