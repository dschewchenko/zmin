...
| Behavior rows written | `173` | explicit command/option/value/state/transport/platform rows written so far |
| Behavior rows matching stock Git | `158/173` | exact written rows with focused parity evidence |
...
| Sharing and Updating Projects | `5` | `309` | `113` | `102` | `9` | `2` |
...
| **Git `2.47.1` unique total** | **`151`** | **`4632`** | **`173`** | **`158`** | **`9`** | **`6`** |
