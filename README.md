...
| Commands with any matrix rows | `57/151` | commands that have started behavior matrices; this is not support |
| Documented option spellings represented by rows | `355/4632` | option spellings that have at least one behavior row; this is not support |
| Written behavior rows | `1545` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `1253/1545` | supported-behavior rows with focused parity evidence |
| Partial written rows | `0/1545` | written rows with incomplete parity |
| Open written rows | `1/1545` | written rows that still do not match stock Git |
| Invalid input rows | `291/1545` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `1253/1545` as Git compatibility. It only means `1253` of the `1545`
rows already written down are closed supported-behavior rows. The larger
unexpanded surface is not counted yet, `0/1545` rows are partially matching,
`1/1545` rows are known open mismatches, and `291/1545` additional rows are
stock-compatible invalid inputs. Do not read `355/4632` as option support
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `212` | `205` | `0` | `0` | `7` |
...
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `51` | `24` | `0` | `0` | `27` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1545`** | **`1253`** | **`0`** | **`1`** | **`291`** |
...
| `diff` | `133` | `0` | `44` | `114` | `112` | `0` | `0` | `2` | no |
| `diff-files` | `130` | `0` | `1` | `3` | `3` | `0` | `0` | `0` | no |
