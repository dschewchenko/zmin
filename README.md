...
| Written behavior rows | `670` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `597/670` | exact written rows with focused parity evidence |
| Open written rows | `2/670` | written rows that still do not match stock Git |
| Invalid input rows | `71/670` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `597/670` as Git compatibility. It only means `597` of the `670`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `210` | `205` | `2` | `3` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`670`** | **`597`** | **`2`** | **`71`** |
...
| `fetch` | `73` | `0` | `28` | `210` | `205` | `0` | `2` | `3` | no |
