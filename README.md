...
| Written behavior rows | `765` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `689/765` | exact written rows with focused parity evidence |
| Open written rows | `0/765` | written rows that still do not match stock Git |
| Invalid input rows | `76/765` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `689/765` as Git compatibility. It only means `689` of the `765`
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `164` | `134` | `0` | `30` |
| Other Git `2.47` commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `1` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`765`** | **`689`** | **`0`** | **`76`** |
...
| `rev-parse` | `72` | `0` | `24` | `41` | `37` | `0` | `0` | `4` | no |
