...
| Written behavior rows | `700` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `625/700` | exact written rows with focused parity evidence |
| Open written rows | `2/700` | written rows that still do not match stock Git |
| Invalid input rows | `73/700` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `625/700` as Git compatibility. It only means `625` of the `700`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `240` | `233` | `2` | `5` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`700`** | **`625`** | **`2`** | **`73`** |
...
| `fetch` | `73` | `0` | `30` | `240` | `233` | `0` | `2` | `5` | no |
