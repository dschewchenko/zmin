...
| Written behavior rows | `682` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `608/682` | exact written rows with focused parity evidence |
| Open written rows | `2/682` | written rows that still do not match stock Git |
| Invalid input rows | `72/682` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `608/682` as Git compatibility. It only means `608` of the `682`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `222` | `216` | `2` | `4` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`682`** | **`608`** | **`2`** | **`72`** |
...
| `fetch` | `73` | `0` | `28` | `222` | `216` | `0` | `2` | `4` | no |
