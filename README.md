...
| Written behavior rows | `705` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `625/705` | exact written rows with focused parity evidence |
| Open written rows | `7/705` | written rows that still do not match stock Git |
| Invalid input rows | `73/705` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `625/705` as Git compatibility. It only means `625` of the `705`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `245` | `233` | `7` | `5` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`705`** | **`625`** | **`7`** | **`73`** |
...
| `fetch` | `73` | `0` | `30` | `245` | `233` | `0` | `7` | `5` | no |
