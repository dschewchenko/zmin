...
| Written behavior rows | `688` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `614/688` | exact written rows with focused parity evidence |
| Open written rows | `2/688` | written rows that still do not match stock Git |
| Invalid input rows | `72/688` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `614/688` as Git compatibility. It only means `614` of the `688`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `228` | `222` | `2` | `4` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`688`** | **`614`** | **`2`** | **`72`** |
...
| `fetch` | `73` | `0` | `28` | `228` | `222` | `0` | `2` | `4` | no |
