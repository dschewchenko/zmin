...
| Written behavior rows | `776` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `700/776` | exact written rows with focused parity evidence |
| Open written rows | `0/776` | written rows that still do not match stock Git |
| Invalid input rows | `76/776` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `700/776` as Git compatibility. It only means `700` of the `776`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `55` | `46` | `0` | `9` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`776`** | **`700`** | **`0`** | **`76`** |
...
| `config` | `243` | `0` | `17` | `55` | `46` | `0` | `0` | `9` | no |
