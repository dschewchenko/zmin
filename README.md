...
| Written behavior rows | `671` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `598/671` | exact written rows with focused parity evidence |
| Open written rows | `2/671` | written rows that still do not match stock Git |
| Invalid input rows | `71/671` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `598/671` as Git compatibility. It only means `598` of the `671`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `211` | `206` | `2` | `3` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`671`** | **`598`** | **`2`** | **`71`** |
...
| `fetch` | `73` | `0` | `28` | `211` | `206` | `0` | `2` | `3` | no |
