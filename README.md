...
| Written behavior rows | `746` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `670/746` | exact written rows with focused parity evidence |
| Open written rows | `0/746` | written rows that still do not match stock Git |
| Invalid input rows | `76/746` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `670/746` as Git compatibility. It only means `670` of the `746`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `280` | `274` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`746`** | **`670`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `280` | `274` | `0` | `0` | `6` | no |
