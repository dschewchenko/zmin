...
| Written behavior rows | `2544` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `2170/2544` | supported-behavior rows with focused parity evidence |
| Partial written rows | `0/2544` | written rows with incomplete parity |
| Open written rows | `1/2544` | written rows that still do not match stock Git |
| Invalid input rows | `373/2544` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `2170/2544` as Git compatibility. It only means `2170` of the `2544`
rows already written down are closed supported-behavior rows. The larger
unexpanded surface is not counted yet, `0/2544` rows are partially matching,
`1/2544` rows are known open mismatches, and `373/2544` additional rows are
...
| Getting and Creating Projects | `2` | `0` | `66` | `0` | `63` | `56` | `0` | `1` | `6` |
| Basic Snapshotting | `9` | `0` | `371` | `0` | `292` | `261` | `0` | `0` | `31` |
| Branching and Merging | `9` | `0` | `581` | `0` | `268` | `225` | `0` | `0` | `43` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `370` | `345` | `0` | `0` | `25` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2544`** | **`2170`** | **`0`** | **`1`** | **`373`** |
