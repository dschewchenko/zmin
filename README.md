...
| Written behavior rows | `735` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `659/735` | exact written rows with focused parity evidence |
| Open written rows | `0/735` | written rows that still do not match stock Git |
| Invalid input rows | `76/735` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `659/735` as Git compatibility. It only means `659` of the `735`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `269` | `263` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`735`** | **`659`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `269` | `263` | `0` | `0` | `6` | no |
