...
| Documented option spellings represented by rows | `606/4632` | option spellings that have at least one behavior row; this is not support |
| Written behavior rows | `2638` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `2261/2638` | supported-behavior rows with focused parity evidence |
| Partial written rows | `0/2638` | written rows with incomplete parity |
| Open written rows | `1/2638` | written rows that still do not match stock Git |
| Invalid input rows | `376/2638` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `2261/2638` as Git compatibility. It only means `2261` of the `2638`
rows already written down are closed supported-behavior rows. The larger
unexpanded surface is not counted yet, `0/2638` rows are partially matching,
`1/2638` rows are known open mismatches, and `376/2638` additional rows are
stock-compatible invalid inputs. Do not read `606/4632` as option support
...
| Branching and Merging | `9` | `0` | `581` | `0` | `272` | `229` | `0` | `0` | `43` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `405` | `380` | `0` | `0` | `25` |
...
| Administration | `8` | `0` | `147` | `0` | `139` | `78` | `0` | `0` | `61` |
| Server Admin | `2` | `0` | `30` | `0` | `2` | `2` | `0` | `0` | `0` |
| Plumbing Commands | `21` | `0` | `650` | `0` | `509` | `442` | `0` | `0` | `67` |
| Other Git 2.47 commands | `70` | `0` | `1069` | `0` | `156` | `120` | `0` | `0` | `36` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`2638`** | **`2261`** | **`0`** | **`1`** | **`376`** |
...
| `pack-objects` | `44` | `0` | `7` | `18` | `12` | `0` | `0` | `6` | no |
| `patch-id` | `4` | `0` | `3` | `6` | `6` | `0` | `0` | `0` | no |
| `prune` | `7` | `0` | `1` | `7` | `6` | `0` | `0` | `1` | no |
| `pull` | `121` | `0` | `2` | `10` | `10` | `0` | `0` | `0` | no |
| `push` | `57` | `0` | `1` | `7` | `6` | `0` | `0` | `1` | no |
| `quiltimport` | `7` | `0` | `2` | `2` | `2` | `0` | `0` | `0` | no |
| `range-diff` | `15` | `0` | `1` | `3` | `3` | `0` | `0` | `0` | no |
| `read-tree` | `22` | `0` | `3` | `4` | `4` | `0` | `0` | `0` | no |
| `rebase` | `103` | `0` | `1` | `1` | `0` | `0` | `0` | `1` | no |
| `reflog` | `13` | `0` | `0` | `15` | `13` | `0` | `0` | `2` | no |
...
| `rm` | `20` | `0` | `7` | `10` | `9` | `0` | `0` | `1` | no |
| `send-email` | `70` | `0` | `2` | `16` | `16` | `0` | `0` | `0` | no |
| `send-pack` | `15` | `0` | `3` | `4` | `3` | `0` | `0` | `1` | no |
...
| `stash` | `30` | `0` | `0` | `207` | `190` | `0` | `0` | `17` | no |
