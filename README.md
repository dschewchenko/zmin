...
| Written behavior rows | `737` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `661/737` | exact written rows with focused parity evidence |
| Open written rows | `0/737` | written rows that still do not match stock Git |
| Invalid input rows | `76/737` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `661/737` as Git compatibility. It only means `661` of the `737`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `271` | `265` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`737`** | **`661`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `271` | `265` | `0` | `0` | `6` | no |
