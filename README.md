...
| Written behavior rows | `719` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `643/719` | exact written rows with focused parity evidence |
| Open written rows | `0/719` | written rows that still do not match stock Git |
| Invalid input rows | `76/719` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `643/719` as Git compatibility. It only means `643` of the `719`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `253` | `247` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`719`** | **`643`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `253` | `247` | `0` | `0` | `6` | no |
