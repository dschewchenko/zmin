...
| Written behavior rows | `678` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `604/678` | exact written rows with focused parity evidence |
| Open written rows | `2/678` | written rows that still do not match stock Git |
| Invalid input rows | `72/678` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `604/678` as Git compatibility. It only means `604` of the `678`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `218` | `212` | `2` | `4` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`678`** | **`604`** | **`2`** | **`72`** |
...
| `fetch` | `73` | `0` | `28` | `218` | `212` | `0` | `2` | `4` | no |
