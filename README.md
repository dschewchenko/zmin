...
| Written behavior rows | `242` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `227/242` | exact written rows with focused parity evidence |
| Open written rows | `9/242` | written rows that still do not match stock Git |
| Invalid input rows | `6/242` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `227/242` as Git compatibility. It only means `227` of the `242`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `182` | `171` | `9` | `2` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`242`** | **`227`** | **`9`** | **`6`** |
...
| `fetch` | `73` | `0` | `28` | `182` | `171` | `0` | `9` | `2` | no |
