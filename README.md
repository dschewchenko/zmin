...
| Written behavior rows | `695` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `621/695` | exact written rows with focused parity evidence |
| Open written rows | `2/695` | written rows that still do not match stock Git |
| Invalid input rows | `72/695` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `621/695` as Git compatibility. It only means `621` of the `695`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `235` | `229` | `2` | `4` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`695`** | **`621`** | **`2`** | **`72`** |
...
| `fetch` | `73` | `0` | `28` | `235` | `229` | `0` | `2` | `4` | no |
