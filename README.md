...
| Written behavior rows | `708` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `633/708` | exact written rows with focused parity evidence |
| Open written rows | `1/708` | written rows that still do not match stock Git |
| Invalid input rows | `74/708` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `633/708` as Git compatibility. It only means `633` of the `708`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `248` | `241` | `1` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`708`** | **`633`** | **`1`** | **`74`** |
...
| `fetch` | `73` | `0` | `30` | `248` | `241` | `0` | `1` | `6` | no |
