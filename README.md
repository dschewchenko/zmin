...
| Written behavior rows | `770` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `694/770` | exact written rows with focused parity evidence |
| Open written rows | `0/770` | written rows that still do not match stock Git |
| Invalid input rows | `76/770` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `694/770` as Git compatibility. It only means `694` of the `770`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `286` | `280` | `0` | `6` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `166` | `136` | `0` | `30` |
| Other Git `2.47` commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `1` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`770`** | **`694`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `286` | `280` | `0` | `0` | `6` | no |
...
| `rev-parse` | `72` | `0` | `24` | `43` | `39` | `0` | `0` | `4` | no |
