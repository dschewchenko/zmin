...
| Written behavior rows | `733` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `657/733` | exact written rows with focused parity evidence |
| Open written rows | `0/733` | written rows that still do not match stock Git |
| Invalid input rows | `76/733` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `657/733` as Git compatibility. It only means `657` of the `733`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `267` | `261` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`733`** | **`657`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `267` | `261` | `0` | `0` | `6` | no |
