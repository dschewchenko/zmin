...
| Written behavior rows | `1000` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `770/1000` | supported-behavior rows with focused parity evidence |
| Partial written rows | `1/1000` | written rows with incomplete parity |
| Open written rows | `0/1000` | written rows that still do not match stock Git |
| Invalid input rows | `229/1000` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `770/1000` as Git compatibility. It only means `770` of the `1000`
rows already written down are closed supported-behavior rows. The larger
unexpanded surface is not counted yet, `1/1000` row is only partially matching
stock Git and `229/1000` additional rows are stock-compatible invalid inputs. Do
...
| Branching and Merging | `9` | `0` | `581` | `0` | `59` | `35` | `0` | `0` | `24` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `296` | `283` | `0` | `0` | `13` |
...
| Other Git `2.47` commands | `71` | `0` | `1075` | `0` | `26` | `7` | `1` | `0` | `18` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`1000`** | **`770`** | **`1`** | **`0`** | **`229`** |
...
| `fast-import` | `25` | `0` | `1` | `2` | `0` | `1` | `0` | `1` | no |
