...
| Written behavior rows | `757` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `681/757` | exact written rows with focused parity evidence |
| Open written rows | `0/757` | written rows that still do not match stock Git |
| Invalid input rows | `76/757` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `681/757` as Git compatibility. It only means `681` of the `757`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `52` | `43` | `0` | `9` |
...
| Inspection and Comparison | `7` | `0` | `774` | `0` | `137` | `134` | `0` | `3` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `160` | `130` | `0` | `30` |
| Other Git `2.47` commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `1` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`757`** | **`681`** | **`0`** | **`76`** |
...
| `config` | `243` | `0` | `17` | `52` | `43` | `0` | `0` | `9` | no |
| `status` | `26` | `0` | `22` | `62` | `58` | `0` | `0` | `4` | no |
| `fetch` | `73` | `0` | `30` | `285` | `279` | `0` | `0` | `6` | no |
| `diff` | `133` | `0` | `31` | `54` | `54` | `0` | `0` | `0` | no |
| `log` | `282` | `0` | `32` | `83` | `80` | `0` | `0` | `3` | no |
| `for-each-ref` | `22` | `0` | `2` | `34` | `23` | `0` | `0` | `11` | no |
| `ls-files` | `42` | `0` | `27` | `54` | `46` | `0` | `0` | `8` | no |
