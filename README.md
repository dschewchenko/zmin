...
| Written behavior rows | `698` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `623/698` | exact written rows with focused parity evidence |
| Open written rows | `2/698` | written rows that still do not match stock Git |
| Invalid input rows | `73/698` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `623/698` as Git compatibility. It only means `623` of the `698`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `238` | `231` | `2` | `5` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`698`** | **`623`** | **`2`** | **`73`** |
...
| `fetch` | `73` | `0` | `30` | `238` | `231` | `0` | `2` | `5` | no |
