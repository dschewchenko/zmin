...
| Behavior rows written | `189` | explicit command/option/value/combination/state/transport/platform rows written so far |
| Behavior rows matching stock Git | `174/189` | exact written rows with focused parity evidence |
| Open written rows | `9/189` | known written rows that are not implemented or not matching yet |
| Invalid input rows | `6/189` | rows where stock Git rejects the input |
...
| Sharing and Updating Projects | `5` | `309` | `129` | `118` | `9` | `2` |
...
| **Git `2.47.1` unique total** | **`151`** | **`4632`** | **`189`** | **`174`** | **`9`** | **`6`** |
