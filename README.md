...
| Written behavior rows | `741` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `665/741` | exact written rows with focused parity evidence |
| Open written rows | `0/741` | written rows that still do not match stock Git |
| Invalid input rows | `76/741` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `665/741` as Git compatibility. It only means `665` of the `741`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `275` | `269` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`741`** | **`665`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `275` | `269` | `0` | `0` | `6` | no |
