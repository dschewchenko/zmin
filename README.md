...
| Written behavior rows | `766` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `690/766` | exact written rows with focused parity evidence |
| Open written rows | `0/766` | written rows that still do not match stock Git |
| Invalid input rows | `76/766` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `690/766` as Git compatibility. It only means `690` of the `766`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Setup and Config | `6` | `0` | `276` | `0` | `54` | `45` | `0` | `9` |
| Getting and Creating Projects | `2` | `0` | `66` | `0` | `0` | `0` | `0` | `0` |
| Basic Snapshotting | `9` | `0` | `371` | `0` | `62` | `58` | `0` | `4` |
| Branching and Merging | `9` | `0` | `581` | `0` | `58` | `35` | `0` | `23` |
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `285` | `279` | `0` | `6` |
| Inspection and Comparison | `7` | `0` | `774` | `0` | `139` | `136` | `0` | `3` |
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `165` | `135` | `0` | `30` |
| Other Git `2.47` commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `1` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`766`** | **`690`** | **`0`** | **`76`** |
...
| `config` | `243` | `0` | `17` | `54` | `45` | `0` | `0` | `9` | no |
| `status` | `26` | `0` | `22` | `62` | `58` | `0` | `0` | `4` | no |
| `fetch` | `73` | `0` | `30` | `285` | `279` | `0` | `0` | `6` | no |
| `diff` | `133` | `0` | `31` | `55` | `55` | `0` | `0` | `0` | no |
| `log` | `282` | `0` | `32` | `84` | `81` | `0` | `0` | `3` | no |
| `for-each-ref` | `22` | `0` | `2` | `34` | `23` | `0` | `0` | `11` | no |
| `ls-files` | `42` | `0` | `27` | `55` | `47` | `0` | `0` | `8` | no |
| `ls-tree` | `15` | `0` | `2` | `4` | `3` | `0` | `0` | `1` | no |
| `merge-base` | `27` | `0` | `2` | `12` | `10` | `0` | `0` | `2` | no |
| `rev-parse` | `72` | `0` | `24` | `42` | `38` | `0` | `0` | `4` | no |
