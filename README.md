...
| Behavior rows written | `155` | explicit command/option/value/state/transport/platform rows in the current matrix |
| Behavior rows closed | `140/155` | exact written rows that match stock Git by focused evidence |
...
| Sharing and Updating Projects | `5` | `309` | `95` | `84` | `9` | `2` |
...
| **Git `2.47` unique total** | **`151`** | **`4632`** | **`155`** | **`140`** | **`9`** | **`6`** |
