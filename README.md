...
| Written behavior rows | `666` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `593/666` | exact written rows with focused parity evidence |
| Open written rows | `2/666` | written rows that still do not match stock Git |
| Invalid input rows | `71/666` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `593/666` as Git compatibility. It only means `593` of the `666`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `206` | `201` | `2` | `3` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`666`** | **`593`** | **`2`** | **`71`** |
...
| `fetch` | `73` | `0` | `28` | `206` | `201` | `0` | `2` | `3` | no |
