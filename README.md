...
| Written behavior rows | `745` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `669/745` | exact written rows with focused parity evidence |
| Open written rows | `0/745` | written rows that still do not match stock Git |
| Invalid input rows | `76/745` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `669/745` as Git compatibility. It only means `669` of the `745`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `279` | `273` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`745`** | **`669`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `279` | `273` | `0` | `0` | `6` | no |
