...
| Written behavior rows | `728` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `652/728` | exact written rows with focused parity evidence |
| Open written rows | `0/728` | written rows that still do not match stock Git |
| Invalid input rows | `76/728` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `652/728` as Git compatibility. It only means `652` of the `728`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `262` | `256` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`728`** | **`652`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `262` | `256` | `0` | `0` | `6` | no |
