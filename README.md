...
| Written behavior rows | `754` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `678/754` | exact written rows with focused parity evidence |
| Open written rows | `0/754` | written rows that still do not match stock Git |
| Invalid input rows | `76/754` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `678/754` as Git compatibility. It only means `678` of the `754`
...
| Plumbing Commands | `20` | `0` | `644` | `0` | `159` | `129` | `0` | `30` |
| Other Git `2.47` commands | `71` | `0` | `1075` | `0` | `3` | `2` | `0` | `1` |
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`754`** | **`678`** | **`0`** | **`76`** |
