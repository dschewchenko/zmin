...
| Behavior rows written | `163` | explicit command/option/value/state/transport/platform rows in the current matrix |
| Behavior rows closed | `148/163` | exact written rows that match stock Git by focused evidence |
...
| Sharing and Updating Projects | `5` | `309` | `103` | `92` | `9` | `2` |
...
| **Git `2.47` unique total** | **`151`** | **`4632`** | **`163`** | **`148`** | **`9`** | **`6`** |
