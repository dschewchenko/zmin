...
| Written behavior rows | `668` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `595/668` | exact written rows with focused parity evidence |
| Open written rows | `2/668` | written rows that still do not match stock Git |
| Invalid input rows | `71/668` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `595/668` as Git compatibility. It only means `595` of the `668`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `208` | `203` | `2` | `3` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`668`** | **`595`** | **`2`** | **`71`** |
...
| `fetch` | `73` | `0` | `28` | `208` | `203` | `0` | `2` | `3` | no |
