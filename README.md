...
| Written behavior rows | `722` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `646/722` | exact written rows with focused parity evidence |
| Open written rows | `0/722` | written rows that still do not match stock Git |
| Invalid input rows | `76/722` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `646/722` as Git compatibility. It only means `646` of the `722`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `256` | `250` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`722`** | **`646`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `256` | `250` | `0` | `0` | `6` | no |
