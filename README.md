...
| Behavior rows written | `143` | explicit command/option/value/state/transport/platform rows in the current matrix |
| Behavior rows closed | `128/143` | exact written rows that match stock Git by focused evidence |
...
| Sharing and Updating Projects | `5` | `309` | `83` | `72` | `9` | `2` |
...
| **Git `2.47` unique total** | **`151`** | **`4632`** | **`143`** | **`128`** | **`9`** | **`6`** |
