...
| Written behavior rows | `773` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `694/773` | exact written rows with focused parity evidence |
| Open written rows | `3/773` | written rows that still do not match stock Git |
| Invalid input rows | `76/773` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `694/773` as Git compatibility. It only means `694` of the `773`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `289` | `280` | `3` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`773`** | **`694`** | **`3`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `289` | `280` | `0` | `3` | `6` | no |
