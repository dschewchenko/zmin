...
| Written behavior rows | `740` | explicit rows currently written in command matrices |
| Written rows matching stock Git | `664/740` | exact written rows with focused parity evidence |
| Open written rows | `0/740` | written rows that still do not match stock Git |
| Invalid input rows | `76/740` | rows where stock Git rejects the input |
| Full Git behavior denominator | not known yet | still being expanded from docs, upstream tests, IDE traces and platform checks |

Do not read `664/740` as Git compatibility. It only means `664` of the `740`
...
| Sharing and Updating Projects | `5` | `0` | `309` | `0` | `274` | `268` | `0` | `6` |
...
| **Git `2.47.1` unique total** | **`151`** | **`0`** | **`4632`** | **`0`** | **`740`** | **`664`** | **`0`** | **`76`** |
...
| `fetch` | `73` | `0` | `30` | `274` | `268` | `0` | `0` | `6` | no |
