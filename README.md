...
| Behavior rows written | `187` | explicit command/option/value/combination/state/transport/platform rows written so far |
| Behavior rows matching stock Git | `172/187` | exact written rows with focused parity evidence |
| Open written rows | `9/187` | known written rows that are not implemented or not matching yet |
| Invalid input rows | `6/187` | rows where stock Git rejects the input |
...
| Sharing and Updating Projects | `5` | `309` | `127` | `116` | `9` | `2` |
...
| **Git `2.47.1` unique total** | **`151`** | **`4632`** | **`187`** | **`172`** | **`9`** | **`6`** |
